(function () {
  ...
  var script = {
      ...
      methods: {
          fetchDashboards () {
              ...
              .then(data => {
                  if (data) {
                      ...
                      this.error = 'Error fetching dashboards';
                      console.error('Error fetching dashboards');
                  }
              })
              .catch(error => {
                  this.error = 'Error parsing dashboards';
          ...
          onSaveClick () {
              ...
              let subscription = {
                  email: this.email,
                  view_name: this.formState.dashboard.id != 0 ? this.getViewName(this.formState.dashboard.url) : 'all',
              ...
              console.debug('Saving', subscription);
              ...
              .then(response => {
                  if (response.ok) {
                      // Success
                      let event = new Event('subscription-created.ft', {user: response.detail});
              ...
              .catch(response => {
                  this.error = 'Error creating subscription or parsing response';
                  console.debug('Error creating subscription or parsing response', response);
              });
          },
          getViewName (url) {
  ...
  var script$1 = {
      ...
      components: {SubscribeModal: __vue_component__}
  };
  ...
  var __vue_render__$1 = function() {
    ...
    return _c(
      ...
      [
        _c("span", { on: { click: _vm.onButtonClick } }, [_vm._t("default")], 2),
        _vm._v(" "),
        _c("subscribe-modal", {
          attrs: {
            server: _vm.server,
            "selected-dashboard": _vm.dashboard,
  ...
  __vue_render__$1._withStripped = true;
    ...
    const __vue_inject_styles__$1 = function (inject) {
      if (!inject) return
      inject("data-v-1036f827_0", { source: ".user-add-button__wrapper[data-v-1036f827] {\n  font-family: -apple-system, BlinkMacSystemFont, \"Segoe UI\", Roboto, \"Helvetica Neue\", Arial, sans-serif, \"Apple Color Emoji\", \"Segoe UI Emoji\", \"Segoe UI Symbol\";\n  -webkit-font-smoothing: antialiased;\n  -moz-osx-font-smoothing: grayscale;\n  text-align: center;\n  color: #212529;\n}\n.user-add-button__wrapper *[data-v-1036f827], .user-add-button__wrapper[data-v-1036f827] ::after, .user-add-button__wrapper[data-v-1036f827] ::before {\n  box-sizing: border-box;\n}\n.user-add-button__wrapper .btn[data-v-1036f827] {\n  border-radius: 2px;\n  padding: 0.5rem 1rem;\n  line-height: 1.5rem;\n  font-size: 1rem;\n  font-weight: bold;\n  border: none;\n  margin-bottom: 20px;\n  color: #fff;\n}\n.user-add-button__wrapper .btn-primary[data-v-1036f827] {\n  background: #fa225b;\n}\n.user-add-button__wrapper .btn-link[data-v-1036f827] {\n  color: #fa225b;\n}\n.user-add-button__wrapper .btn-block[data-v-1036f827] {\n  display: block;\n  width: 100%;\n}\n.user-add-button__wrapper .btn[data-v-1036f827]:hover {\n  cursor: pointer;\n  box-shadow: 0 0 10px 4px rgba(250, 34, 91, 0.1);\n}\n.user-add-button__wrapper .btn[data-v-1036f827]:focus {\n  outline: 0;\n}\n\n/*# sourceMappingURL=SubscribeButton.vue.map */", map: {"version":3,"sources":["/Users/dylan/dev/zuar/frontendtoolbox/src/elements/SubscribeButton/SubscribeButton.vue","SubscribeButton.vue"],"names":[],"mappings":"AAsCA;EACA,iKAAA;EACA,mCAAA;EACA,kCAAA;EACA,kBAAA;EACA,cAAA;ACrCA;ADuCA;EACA,sBAAA;ACrCA;ADwCA;EACA,kBAAA;EACA,oBAAA;EACA,mBAAA;EACA,eAAA;EACA,iBAAA;EACA,YAAA;EACA,mBAAA;EACA,WAAA;ACtCA;ADwCA;EACA,mBAAA;ACtCA;ADwCA;EACA,cAAA;ACtCA;ADwCA;EACA,cAAA;EACA,WAAA;ACtCA;ADwCA;EACA,eAAA;EACA,+CAAA;ACtCA;ADwCA;EACA,UAAA;ACtCA;;AAEA,8CAA8C","file":"SubscribeButton.vue","sourcesContent":["<template>\n    <div class=\"user-add-button__wrapper\">\n        <span v-on:click=\"onButtonClick\">\n            <slot></slot>\n        </span>\n        <subscribe-modal :server=\"server\" :selected-dashboard=\"dashboard\" :open-modal=\"openModal\" :on-close=\"onModalClose\"></subscribe-modal>\n    </div>\n</template>\n\n<script>\n    import SubscribeModal from '../SubscribeModal/SubscribeModal.vue';\n    export default {\n        name: 'UserAddButton',\n        props: {\n            server: String,\n            buttonText: String,\n            dashboard: Object\n        },\n        data: () => {\n            return {\n                openModal: false\n            };\n        },\n        methods: {\n            onButtonClick () {\n                this.openModal = true;\n            },\n            onModalClose () {\n                console.debug('modal close callback');\n                this.openModal = false;\n            }\n        },\n        components: {SubscribeModal}\n    };\n</script>\n\n<style scoped lang=\"scss\">\n    \n    .user-add-button__wrapper {\n        font-family: -apple-system,BlinkMacSystemFont,\"Segoe UI\",Roboto,\"Helvetica Neue\",Arial,sans-serif,\"Apple Color Emoji\",\"Segoe UI Emoji\",\"Segoe UI Symbol\";\n        -webkit-font-smoothing: antialiased;\n        -moz-osx-font-smoothing: grayscale;\n        text-align: center;\n        color: #212529;\n\n        *, ::after, ::before {\n            box-sizing: border-box;\n        }\n\n        .btn {\n            border-radius: 2px;\n            padding: .5rem 1rem;\n            line-height: 1.5rem;\n            font-size: 1rem;\n            font-weight: bold;\n            border: none;\n            margin-bottom: 20px;\n            color: #fff;\n        }\n        .btn-primary {\n            background: #fa225b;\n        }\n        .btn-link {\n            color: #fa225b;\n        }\n        .btn-block {\n            display: block;\n            width: 100%;\n        }\n        .btn:hover {\n            cursor: pointer;\n            box-shadow: 0 0 10px 4px rgba(250, 34, 91, 0.1);\n        }\n        .btn:focus {\n            outline: 0;\n        }\n    }\n</style>\n",".user-add-button__wrapper {\n  font-family: -apple-system, BlinkMacSystemFont, \"Segoe UI\", Roboto, \"Helvetica Neue\", Arial, sans-serif, \"Apple Color Emoji\", \"Segoe UI Emoji\", \"Segoe UI Symbol\";\n  -webkit-font-smoothing: antialiased;\n  -moz-osx-font-smoothing: grayscale;\n  text-align: center;\n  color: #212529;\n}\n.user-add-button__wrapper *, .user-add-button__wrapper ::after, .user-add-button__wrapper ::before {\n  box-sizing: border-box;\n}\n.user-add-button__wrapper .btn {\n  border-radius: 2px;\n  padding: 0.5rem 1rem;\n  line-height: 1.5rem;\n  font-size: 1rem;\n  font-weight: bold;\n  border: none;\n  margin-bottom: 20px;\n  color: #fff;\n}\n.user-add-button__wrapper .btn-primary {\n  background: #fa225b;\n}\n.user-add-button__wrapper .btn-link {\n  color: #fa225b;\n}\n.user-add-button__wrapper .btn-block {\n  display: block;\n  width: 100%;\n}\n.user-add-button__wrapper .btn:hover {\n  cursor: pointer;\n  box-shadow: 0 0 10px 4px rgba(250, 34, 91, 0.1);\n}\n.user-add-button__wrapper .btn:focus {\n  outline: 0;\n}\n\n/*# sourceMappingURL=SubscribeButton.vue.map */"]}, media: undefined });

    };
    /* scoped */
    const __vue_scope_id__$1 = "data-v-1036f827";
    /* module identifier */
  ...
  Vue.customElement('subscribe-button', __vue_component__$1);
