(function (exports) {
  ...
  var __vue_render__ = function() {
    ...
    return _vm.source
      ? _c("div", { staticClass: "z-background-wrapper" }, [
          _vm.type === "image"
            ? _c("div", {
                staticClass: "z-background-image",
                style: { backgroundImage: "url(" + _vm.source + ")" },
                attrs: { "test-id": "background-image" }
              })
            : _vm.type === "color"
            ? _c("div", {
                staticClass: "z-background-color",
                style: { backgroundColor: _vm.source },
                attrs: { "test-id": "background-color" }
              })
            : _vm.type === "video"
            ? _c(
                "video",
                {
                  staticClass: "z-background-video",
                  attrs: {
                    autoplay: "",
                    muted: "",
                    loop: "",
                    "test-id": "background-video"
                  },
                  domProps: { muted: true }
                },
  ...
  __vue_render__._withStripped = true;
    ...
    const __vue_inject_styles__ = function (inject) {
      if (!inject) return
      inject("data-v-40e92dee_0", { source: "\nz-background-visual {\n    display: block;\n    position: absolute;\n    top: 0;\n    left: 0;\n    width: 100%;\n    height: 100%;\n}\n.z-background-wrapper {\n    width: 100%;\n    height: 100%;\n    position: relative;\n    overflow: hidden;\n}\n.z-background-color {\n    width: 100%;\n    height: 100%;\n}\n.z-background-image {\n    width: 100%;\n    height: 100%;\n    background-position: center;\n    background-size: cover;\n}\n.z-background-video {\n    position: relative; /* fixed */\n    top: 0;\n    left: 50%;\n    /* z-index: -1; */\n    pointer-events: none;\n    overflow: hidden;\n    min-height: 100vh;\n    min-width: 100vw;\n    transform: translate(-50%);\n}\n.z-background-video source {\n    width: 100vw;\n    height: 56.25vw;\n    min-height: 100vh;\n    min-width: 177.77vh;\n    position: absolute;\n    top: 50%;\n    left: 50%;\n    transform: translate(-50%, -50%);\n}\n", map: {"version":3,"sources":["/Users/dylanspurgin/dev/apitoolbox-ui/src/elements/BackgroundVisual/BackgroundVisual.vue"],"names":[],"mappings":";AA4CA;IACA,cAAA;IACA,kBAAA;IACA,MAAA;IACA,OAAA;IACA,WAAA;IACA,YAAA;AACA;AACA;IACA,WAAA;IACA,YAAA;IACA,kBAAA;IACA,gBAAA;AACA;AACA;IACA,WAAA;IACA,YAAA;AACA;AACA;IACA,WAAA;IACA,YAAA;IACA,2BAAA;IACA,sBAAA;AACA;AACA;IACA,kBAAA,EAAA,UAAA;IACA,MAAA;IACA,SAAA;IACA,iBAAA;IACA,oBAAA;IACA,gBAAA;IACA,iBAAA;IACA,gBAAA;IACA,0BAAA;AACA;AACA;IACA,YAAA;IACA,eAAA;IACA,iBAAA;IACA,mBAAA;IACA,kBAAA;IACA,QAAA;IACA,SAAA;IACA,gCAAA;AACA","file":"BackgroundVisual.vue","sourcesContent":["<template>\n    <div class=\"z-background-wrapper\" v-if=\"source\">\n        <div v-if=\"type==='image'\" class=\"z-background-image\" v-bind:style=\"{backgroundImage: 'url(' + source + ')'}\" test-id=\"background-image\"></div>\n        <div v-else-if=\"type==='color'\" class=\"z-background-color\" v-bind:style=\"{backgroundColor: source}\" test-id=\"background-color\"></div>\n        <video v-else-if=\"type==='video'\" class=\"z-background-video\" autoplay muted loop test-id=\"background-video\">\n            <source v-bind:src=\"source\" type=\"video/mp4\">\n        </video>\n    </div>\n</template>\n\n<script>\nexport default {\n    name: 'BackgroundVisual',\n    props: {\n        src: String,\n        color: String,\n    },\n    data() {\n        return {\n            hexColorRegex: /^#.{6}$/g\n        }\n    },\n    computed: {\n        source() {\n            return this.src || this.color || '';\n        },\n        type() {\n            if (this.source) {\n                if (this.source.endsWith('.mp4') || this.source.endsWith('.mov') || this.source.endsWith('.webm')) {\n                    return 'video';\n                } else if (this.hexColorRegex.test(this.source)){ \n                    return 'color';\n                } else {\n                    return 'image';\n                }\n            } else {\n                return false;\n            }\n        }\n    }\n};\n</script>\n\n<style>\n    z-background-visual {\n        display: block;\n        position: absolute;\n        top: 0;\n        left: 0;\n        width: 100%;\n        height: 100%;\n    }\n    .z-background-wrapper {\n        width: 100%;\n        height: 100%;\n        position: relative;\n        overflow: hidden;\n    }\n    .z-background-color {\n        width: 100%;\n        height: 100%;\n    }\n    .z-background-image {\n        width: 100%;\n        height: 100%;\n        background-position: center;\n        background-size: cover;\n    }\n    .z-background-video {\n        position: relative; /* fixed */\n        top: 0;\n        left: 50%;\n        /* z-index: -1; */\n        pointer-events: none;\n        overflow: hidden;\n        min-height: 100vh;\n        min-width: 100vw;\n        transform: translate(-50%);\n    }\n    .z-background-video source {\n        width: 100vw;\n        height: 56.25vw;\n        min-height: 100vh;\n        min-width: 177.77vh;\n        position: absolute;\n        top: 50%;\n        left: 50%;\n        transform: translate(-50%, -50%);\n    }\n</style>\n"]}, media: undefined });
  ...
  var __vue_render__$1 = function() {
    ...
    return _c(
      ...
      [
        _c(
          "div",
          { ref: "modalWrapper", staticClass: "modal-window confirmation-modal" },
          [
                ...
                [
                  _c("div", { staticClass: "modal-content" }, [
                    _c("header", { staticClass: "modal-header" }, [
                      _c("h3", [_vm._v(_vm._s(_vm.headingLocal))])
                    ]),
                    _vm._v(" "),
                    ...
                    _c("footer", { staticClass: "modal-footer" }, [
                      ...
                      _c(
                        ...
                        [
                          _vm._v(
                            "\n                            " +
                              _vm._s(_vm.confirmBtnTextLocal) +
                              "\n                        "
                          )
                        ]
                      )
  ...
  var __vue_render__$2 = function() {
    ...
    return _c(
      ...
      [
        _c(
          "div",
          { ref: "modalWrapper", staticClass: "modal-window group-edit-modal" },
          [
            _c("div", { ref: "modal", staticClass: "modal fade" }, [
              _c("div", { staticClass: "modal-dialog modal-md" }, [
                _c("div", { staticClass: "modal-content" }, [
                  _c("header", { staticClass: "modal-header" }, [
                    !_vm.groupId ? _c("h3", [_vm._v("Add Group")]) : _vm._e(),
                    _vm._v(" "),
                    _vm.groupId ? _c("h3", [_vm._v("Edit Group")]) : _vm._e()
                  ]),
                  _vm._v(" "),
                  _c("main", { staticClass: "modal-body" }, [
                    _c("div", { staticClass: "container-fluid" }, [
                            ...
                            [
                              _c("div", { staticClass: "mb-3" }, [
                                ...
                                _c("input", {
                                  directives: [
                                    {
                                      name: "model",
                                      rawName: "v-model",
                                      value: _vm.groupToEdit.name,
                                      expression: "groupToEdit.name"
                                    }
                                  ],
                                  ref: "name",
                                  ...
                                  domProps: { value: _vm.groupToEdit.name },
                                  on: {
                                ...
                                _c("div", { staticClass: "invalid-feedback" }, [
                                  _vm._v(
                                    "Please provide a group name. Eg; Editor."
                                  )
                                ])
                              ]),
                              _vm._v(" "),
  ...
  __vue_render__$2._withStripped = true;
    ...
    const __vue_inject_styles__$2 = function (inject) {
      if (!inject) return
      inject("data-v-8c1da41c_0", { source: "fieldset[disabled] .multiselect{pointer-events:none}.multiselect__spinner{position:absolute;right:1px;top:1px;width:48px;height:35px;background:#fff;display:block}.multiselect__spinner:after,.multiselect__spinner:before{position:absolute;content:\"\";top:50%;left:50%;margin:-8px 0 0 -8px;width:16px;height:16px;border-radius:100%;border:2px solid transparent;border-top-color:#41b883;box-shadow:0 0 0 1px transparent}.multiselect__spinner:before{animation:spinning 2.4s cubic-bezier(.41,.26,.2,.62);animation-iteration-count:infinite}.multiselect__spinner:after{animation:spinning 2.4s cubic-bezier(.51,.09,.21,.8);animation-iteration-count:infinite}.multiselect__loading-enter-active,.multiselect__loading-leave-active{transition:opacity .4s ease-in-out;opacity:1}.multiselect__loading-enter,.multiselect__loading-leave-active{opacity:0}.multiselect,.multiselect__input,.multiselect__single{font-family:inherit;font-size:16px;-ms-touch-action:manipulation;touch-action:manipulation}.multiselect{box-sizing:content-box;display:block;position:relative;width:100%;min-height:40px;text-align:left;color:#35495e}.multiselect *{box-sizing:border-box}.multiselect:focus{outline:none}.multiselect--disabled{background:#ededed;pointer-events:none;opacity:.6}.multiselect--active{z-index:50}.multiselect--active:not(.multiselect--above) .multiselect__current,.multiselect--active:not(.multiselect--above) .multiselect__input,.multiselect--active:not(.multiselect--above) .multiselect__tags{border-bottom-left-radius:0;border-bottom-right-radius:0}.multiselect--active .multiselect__select{transform:rotate(180deg)}.multiselect--above.multiselect--active .multiselect__current,.multiselect--above.multiselect--active .multiselect__input,.multiselect--above.multiselect--active .multiselect__tags{border-top-left-radius:0;border-top-right-radius:0}.multiselect__input,.multiselect__single{position:relative;display:inline-block;min-height:20px;line-height:20px;border:none;border-radius:5px;background:#fff;padding:0 0 0 5px;width:100%;transition:border .1s ease;box-sizing:border-box;margin-bottom:8px;vertical-align:top}.multiselect__input:-ms-input-placeholder{color:#35495e}.multiselect__input::placeholder{color:#35495e}.multiselect__tag~.multiselect__input,.multiselect__tag~.multiselect__single{width:auto}.multiselect__input:hover,.multiselect__single:hover{border-color:#cfcfcf}.multiselect__input:focus,.multiselect__single:focus{border-color:#a8a8a8;outline:none}.multiselect__single{padding-left:5px;margin-bottom:8px}.multiselect__tags-wrap{display:inline}.multiselect__tags{min-height:40px;display:block;padding:8px 40px 0 8px;border-radius:5px;border:1px solid #e8e8e8;background:#fff;font-size:14px}.multiselect__tag{position:relative;display:inline-block;padding:4px 26px 4px 10px;border-radius:5px;margin-right:10px;color:#fff;line-height:1;background:#41b883;margin-bottom:5px;white-space:nowrap;overflow:hidden;max-width:100%;text-overflow:ellipsis}.multiselect__tag-icon{cursor:pointer;margin-left:7px;position:absolute;right:0;top:0;bottom:0;font-weight:700;font-style:normal;width:22px;text-align:center;line-height:22px;transition:all .2s ease;border-radius:5px}.multiselect__tag-icon:after{content:\"\\D7\";color:#266d4d;font-size:14px}.multiselect__tag-icon:focus,.multiselect__tag-icon:hover{background:#369a6e}.multiselect__tag-icon:focus:after,.multiselect__tag-icon:hover:after{color:#fff}.multiselect__current{min-height:40px;overflow:hidden;padding:8px 30px 0 12px;white-space:nowrap;border-radius:5px;border:1px solid #e8e8e8}.multiselect__current,.multiselect__select{line-height:16px;box-sizing:border-box;display:block;margin:0;text-decoration:none;cursor:pointer}.multiselect__select{position:absolute;width:40px;height:38px;right:1px;top:1px;padding:4px 8px;text-align:center;transition:transform .2s ease}.multiselect__select:before{position:relative;right:0;top:65%;color:#999;margin-top:4px;border-color:#999 transparent transparent;border-style:solid;border-width:5px 5px 0;content:\"\"}.multiselect__placeholder{color:#adadad;display:inline-block;margin-bottom:10px;padding-top:2px}.multiselect--active .multiselect__placeholder{display:none}.multiselect__content-wrapper{position:absolute;display:block;background:#fff;width:100%;max-height:240px;overflow:auto;border:1px solid #e8e8e8;border-top:none;border-bottom-left-radius:5px;border-bottom-right-radius:5px;z-index:50;-webkit-overflow-scrolling:touch}.multiselect__content{list-style:none;display:inline-block;padding:0;margin:0;min-width:100%;vertical-align:top}.multiselect--above .multiselect__content-wrapper{bottom:100%;border-bottom-left-radius:0;border-bottom-right-radius:0;border-top-left-radius:5px;border-top-right-radius:5px;border-bottom:none;border-top:1px solid #e8e8e8}.multiselect__content::webkit-scrollbar{display:none}.multiselect__element{display:block}.multiselect__option{display:block;padding:12px;min-height:40px;line-height:16px;text-decoration:none;text-transform:none;vertical-align:middle;position:relative;cursor:pointer;white-space:nowrap}.multiselect__option:after{top:0;right:0;position:absolute;line-height:40px;padding-right:12px;padding-left:20px;font-size:13px}.multiselect__option--highlight{background:#41b883;outline:none;color:#fff}.multiselect__option--highlight:after{content:attr(data-select);background:#41b883;color:#fff}.multiselect__option--selected{background:#f3f3f3;color:#35495e;font-weight:700}.multiselect__option--selected:after{content:attr(data-selected);color:silver}.multiselect__option--selected.multiselect__option--highlight{background:#ff6a6a;color:#fff}.multiselect__option--selected.multiselect__option--highlight:after{background:#ff6a6a;content:attr(data-deselect);color:#fff}.multiselect--disabled .multiselect__current,.multiselect--disabled .multiselect__select{background:#ededed;color:#a6a6a6}.multiselect__option--disabled{background:#ededed!important;color:#a6a6a6!important;cursor:text;pointer-events:none}.multiselect__option--group{background:#ededed;color:#35495e}.multiselect__option--group.multiselect__option--highlight{background:#35495e;color:#fff}.multiselect__option--group.multiselect__option--highlight:after{background:#35495e}.multiselect__option--disabled.multiselect__option--highlight{background:#dedede}.multiselect__option--group-selected.multiselect__option--highlight{background:#ff6a6a;color:#fff}.multiselect__option--group-selected.multiselect__option--highlight:after{background:#ff6a6a;content:attr(data-deselect);color:#fff}.multiselect-enter-active,.multiselect-leave-active{transition:all .15s ease}.multiselect-enter,.multiselect-leave-active{opacity:0}.multiselect__strong{margin-bottom:8px;line-height:20px;display:inline-block;vertical-align:top}[dir=rtl] .multiselect{text-align:right}[dir=rtl] .multiselect__select{right:auto;left:1px}[dir=rtl] .multiselect__tags{padding:8px 8px 0 40px}[dir=rtl] .multiselect__content{text-align:right}[dir=rtl] .multiselect__option:after{right:auto;left:0}[dir=rtl] .multiselect__clear{right:auto;left:12px}[dir=rtl] .multiselect__spinner{right:auto;left:1px}@keyframes spinning{0%{transform:rotate(0)}to{transform:rotate(2turn)}}", map: undefined, media: undefined })
  ,inject("data-v-8c1da41c_1", { source: ".group-edit-modal {\n  position: fixed;\n  top: 0;\n  left: 0;\n  width: 100%;\n  height: 100%;\n  z-index: 999;\n  background-color: rgba(0, 0, 0, 0.4);\n  transition: all 0.3s;\n}\n.group-edit-modal *, .group-edit-modal ::after, .group-edit-modal ::before {\n  box-sizing: border-box;\n}\n.group-edit-modal .modal {\n  display: block;\n}\n.group-edit-modal .modal-dialog {\n  max-width: 500px;\n  position: relative;\n  margin: 1.75rem auto;\n  transition: transform 0.3s ease-out;\n}\n.group-edit-modal .modal-content {\n  height: auto;\n  background: #ffffff;\n  pointer-events: all;\n}\n.group-edit-modal .form-control:focus {\n  outline: 0;\n}\n.group-edit-modal .modal-footer {\n  display: flex;\n  justify-content: flex-end;\n}\n\n/*# sourceMappingURL=GroupEditModal.vue.map */", map: {"version":3,"sources":["/Users/dylanspurgin/dev/apitoolbox-ui/src/elements/GroupEditModal/GroupEditModal.vue","GroupEditModal.vue"],"names":[],"mappings":"AAkRA;EACA,eAAA;EACA,MAAA;EACA,OAAA;EACA,WAAA;EACA,YAAA;EACA,YAAA;EACA,oCAAA;EACA,oBAAA;ACjRA;ADkRA;EACA,sBAAA;AChRA;ADkRA;EACA,cAAA;AChRA;ADkRA;EACA,gBAAA;EACA,kBAAA;EACA,oBAAA;EACA,mCAAA;AChRA;ADkRA;EACA,YAAA;EACA,mBAAA;EACA,mBAAA;AChRA;ADmRA;EACA,UAAA;ACjRA;ADmRA;EACA,aAAA;EACA,yBAAA;ACjRA;;AAEA,6CAA6C","file":"GroupEditModal.vue","sourcesContent":["<template>\n    <div v-show=\"false\" ref=\"modalTemplate\">\n        <div class=\"modal-window group-edit-modal\" ref=\"modalWrapper\">\n            <div class=\"modal fade\" ref=\"modal\">\n                <div class=\"modal-dialog modal-md\">\n                    <div class=\"modal-content\">\n                        <header class=\"modal-header\">\n                            <h3 v-if=\"!groupId\">Add Group</h3>\n                            <h3 v-if=\"groupId\">Edit Group</h3>\n                        </header>\n                        <main class=\"modal-body\">\n                            <div class=\"container-fluid\">\n                                <div class=\"row\">\n                                    <div class=\"col\">\n                                        <form class=\"form needs-validation\" ref=\"form\" novalidate>\n                                            <div class=\"mb-3\">\n                                                <label for=\"name\">Name</label>\n                                                <input\n                                                    type=\"text\"\n                                                    class=\"form-control\"\n                                                    id=\"name\"\n                                                    name=\"name\"\n                                                    placeholder=\"Name\"\n                                                    ref=\"name\"\n                                                    v-model=\"groupToEdit.name\"\n                                                    :required=\"true\">\n                                                <div class=\"invalid-feedback\">Please provide a group name. Eg; Editor.</div>\n                                            </div>\n                                            <div class=\"mb-3\">\n                                                <label for=\"permissions\">Permissions</label>\n                                                <multiselect \n                                                    v-model=\"selectedPermissions\" \n                                                    :options=\"permissions\"\n                                                    id=\"permissions\"\n                                                    tag-placeholder=\"Add as new permission\"\n                                                    placeholder=\"Permissions\"\n                                                    label=\"alias\"\n                                                    track-by=\"id\"\n                                                    :multiple=\"true\" \n                                                    :taggable=\"false\">\n                                                </multiselect>\n                                            </div>\n                                        </form>\n                                    </div>\n                                </div>\n                            </div>\n                        </main>\n                        <footer class=\"modal-footer\">\n                            <button v-on:click=\"onCancelClick\" class=\"btn btn-secondary\">\n                                Cancel\n                            </button>\n                            <button\n                                v-on:click=\"onSaveClick\"\n                                class=\"btn btn-primary\">\n                                Save\n                            </button>\n                        </footer>\n                    </div>\n                </div>\n            </div>\n        </div>\n    </div>\n</template>\n\n<script>\nimport Multiselect from 'vue-multiselect';\nexport default {\n    name: \"GroupEditModal\",\n    props: {\n        server: {\n            type: String,\n            default: ''\n        },\n        openModal: Boolean, // Requested modal state\n        groupId: String\n    },\n    data: () => {\n        return {\n            groupToEdit: {},\n            initialPermissions: [],\n            permissions: [],\n            selectedPermissions: [],\n            isOpen: false // Actual modal state\n        };\n    },\n    watch: {\n        openModal: function(val) {\n            if (val === this.isOpen) {\n                // Already in requested state\n                return;\n            }\n            if (val) {\n                this.groupToEdit = {};\n                if (this.groupId) {\n                    this.fetchGroup(this.groupId)\n                }\n\n                this.fetchPermissions()\n                    .then(() => {\n                        if (this.groupId) {\n                            this.fetchGroupPermissions(this.groupId);\n                        }\n                    });\n\n                this.open();\n            } else {\n                this.close();\n            }\n        }\n    },\n    methods: {\n        onCancelClick() {\n            this.close();\n        },\n        onSaveClick() {\n            if (this.$refs.form.checkValidity() === false) {\n                this.$refs.form.classList.add('was-validated');\n                return;\n            }\n\n            this.saveGroup()\n                .then(groupResponse => {\n                    this.saveGroupPermissions()\n                        .then(() => {\n                            let event;\n                            if (this.groupToEdit.id) {\n                                event = new CustomEvent('group-edited.at', {detail: {group: groupResponse}})\n                            } else {\n                                event = new CustomEvent('group-created.at', {detail: {group: groupResponse}})\n                            }\n                            document.dispatchEvent(event);\n                        });\n                })\n                .catch(err => {\n                    console.error('Error creating group or parsing response', err);\n                })\n            this.close();\n        },\n        fetchGroup (id) {\n            return fetch(`${this.server}/auth/groups/${id}`)\n                .then(this.handleResponse)\n                .then(group => {\n                    this.groupToEdit = {};\n                    Object.assign(this.groupToEdit, group);\n                })\n                .catch(e => {\n                    console.error('Error fetching group', e);\n                });\n        },\n        fetchGroupPermissions (groupId) {\n            return fetch(`${this.server}/auth/groups/${groupId}/permissions`)\n                .then(this.handleResponse)\n                .then(permissions => {\n                    this.initialPermissions.length = 0;\n                    this.initialPermissions.push(...permissions);\n\n                    this.selectedPermissions.length = 0;\n                    this.selectedPermissions.push(...permissions);\n                    this.selectedPermissions.sort(permissionSort);\n                })\n                .catch(e => {\n                    console.error('Error fetching group', e);\n                });\n        },\n        fetchPermissions () {\n            return fetch(`${this.server}/auth/permissions`)\n                .then(this.handleResponse)\n                .then(permissions => {\n                    this.permissions = [];\n                    this.permissions.push(...permissions);\n                    this.permissions.sort(permissionSort);\n                })\n                .catch(e => {\n                    console.error('Error fetching permissions', e);\n                });\n        },\n        saveGroup () {\n            let group = Object.assign({}, this.groupToEdit); // So we don't break permissions in UI\n            let request;\n            if (this.groupId) {\n                request = fetch(`${this.server}/auth/groups/${this.groupId}`, {\n                    method: \"PUT\",\n                    headers: {\n                        \"Content-Type\": \"application/json\"\n                    },\n                    body: JSON.stringify(group)\n                });\n            } else {\n                request = fetch(`${this.server}/auth/groups`, {\n                    method: \"POST\",\n                    headers: {\n                        \"Content-Type\": \"application/json\"\n                    },\n                    body: JSON.stringify(group)\n                });\n            }\n            return request\n                .then(this.handleResponse)\n                .then(group => {\n                    this.groupId = group.id;\n                    return Promise.resolve(group);\n                });\n        },\n        saveGroupPermissions () {\n            let requests = [];\n            this.selectedPermissions.forEach(selectedPermission => {\n                if (!this.initialPermissions.find(ip => ip.id === selectedPermission.id)) {\n                    requests.push(this.grantGroupPermission(selectedPermission));\n                }\n            });\n            this.initialPermissions.forEach(initialPermission => {\n                if (!this.selectedPermissions.find(sp => sp.id === initialPermission.id)) {\n                    requests.push(this.revokeGroupPermission(initialPermission));\n                }\n            });\n            return Promise.all(requests);\n        },\n        grantGroupPermission (permission) {\n            return fetch(`${this.server}/auth/groups/${this.groupId}/permissions`, {\n                    method: 'POST',\n                    headers: {\n                        \"Content-Type\": \"application/json\"\n                    },\n                    body: JSON.stringify({permission_id: permission.id})\n                })\n                .then(this.handleResponse);\n        },\n        revokeGroupPermission (permission) {\n            return fetch(`${this.server}/auth/groups/${this.groupId}/permissions/${permission.id}`, {\n                    method: 'DELETE',\n                    headers: {'Content-Type': 'application/json'}\n                })\n                .then(this.handleResponse);\n        },\n        handleResponse (response) {\n            return response.json()\n                .then((json) => {\n                    if (!response.ok) {\n                        const error = Object.assign({}, json, {\n                            status: response.status,\n                            statusText: response.statusText,\n                        });\n                        return Promise.reject(error);\n                    }\n                    return json;\n                });\n        },\n        open () {\n            document.body.appendChild(this.$refs.modalWrapper);\n            window.setTimeout(() => {\n                this.$refs.modal.classList.add('show');    \n            }, 100);\n            \n            this.isOpen = true;\n        },\n        close () {\n            this.$refs.modal.classList.remove('show');\n            this.$refs.form.classList.remove('was-validated');\n            window.setTimeout(() => {\n                this.$refs.modalTemplate.appendChild(this.$refs.modalWrapper);\n            }, 300);\n            this.isOpen = false;\n        }\n    },\n    components: {\n        Multiselect\n    }\n};\nfunction permissionSort (a, b) {\n    return a.alias.toLowerCase().localeCompare(b.alias.toLowerCase());\n}\n</script>\n<style src=\"vue-multiselect/dist/vue-multiselect.min.css\"></style>\n<style lang=\"scss\">\n    .group-edit-modal {\n        position: fixed;\n        top: 0;\n        left: 0;\n        width: 100%;\n        height: 100%;\n        z-index: 999;\n        background-color: rgba(0, 0, 0, .4);\n        transition: all 0.3s;\n        *, ::after, ::before {\n            box-sizing: border-box;\n        }\n        .modal {\n            display: block;\n        }\n        .modal-dialog {\n            max-width: 500px;\n            position: relative;\n            margin: 1.75rem auto;\n            transition: transform .3s ease-out;\n        }\n        .modal-content {\n            height: auto;\n            background: #ffffff;\n            pointer-events: all;\n        }\n\n        .form-control:focus {\n            outline: 0;\n        }\n        .modal-footer {\n            display: flex;\n            justify-content: flex-end;\n        }\n    }\n</style>\n",".group-edit-modal {\n  position: fixed;\n  top: 0;\n  left: 0;\n  width: 100%;\n  height: 100%;\n  z-index: 999;\n  background-color: rgba(0, 0, 0, 0.4);\n  transition: all 0.3s;\n}\n.group-edit-modal *, .group-edit-modal ::after, .group-edit-modal ::before {\n  box-sizing: border-box;\n}\n.group-edit-modal .modal {\n  display: block;\n}\n.group-edit-modal .modal-dialog {\n  max-width: 500px;\n  position: relative;\n  margin: 1.75rem auto;\n  transition: transform 0.3s ease-out;\n}\n.group-edit-modal .modal-content {\n  height: auto;\n  background: #ffffff;\n  pointer-events: all;\n}\n.group-edit-modal .form-control:focus {\n  outline: 0;\n}\n.group-edit-modal .modal-footer {\n  display: flex;\n  justify-content: flex-end;\n}\n\n/*# sourceMappingURL=GroupEditModal.vue.map */"]}, media: undefined });
  ...
  var script$3 = {
      ...
      components: {GroupEditModal: __vue_component__$2}
  };
  ...
  var __vue_render__$3 = function() {
    ...
    return _c(
      "div",
      { staticClass: "group-list__wrapper container" },
      [
        _c("div", { staticClass: "row justify-content-sm-end" }, [
          _vm._m(0),
          _vm._v(" "),
          _c("div", { staticClass: "col col-sm-6 d-flex justify-content-end" }, [
            _c(
              "button",
              {
                staticClass: "btn btn-primary",
                on: { click: _vm.onAddGroupClick }
              },
              [_vm._v("Add Group")]
            )
          ])
        ...
        _c("div", { staticClass: "row mt-4" }, [
          _c("div", { staticClass: "col" }, [
            _c(
              "table",
              { staticClass: "table table-striped table-responsive-xs" },
              [
                _vm._m(1),
                _vm._v(" "),
                _c(
                            ...
                            _c("td", [
                              ...
                              _c(
                                "button",
                                {
                                  ...
                                  on: {
                                    click: function($event) {
                                      return _vm.onDeleteClick(group)
                                    }
                                  }
                                },
                                [_vm._v("Delete")]
  ...
  var __vue_staticRenderFns__$3 = [
    function() {
      ...
      return _c(
        "div",
        { staticClass: "col col-sm-6 d-flex justify-content-start" },
        [_c("h3", [_vm._v("Groups")])]
      )
    },
    function() {
      ...
      return _c("thead", [
        _c("tr", [
          _c("th", [_vm._v("Name")]),
          _vm._v(" "),
          _c("th", { attrs: { width: "1" } }, [_vm._v("Actions")])
        ])
      ])
    }
  ];
  __vue_render__$3._withStripped = true;
    ...
    const __vue_inject_styles__$3 = function (inject) {
      if (!inject) return
      inject("data-v-6b2b458d_0", { source: ".group-list__wrapper {\n  font-family: -apple-system, BlinkMacSystemFont, \"Segoe UI\", Roboto, \"Helvetica Neue\", Arial, sans-serif, \"Apple Color Emoji\", \"Segoe UI Emoji\", \"Segoe UI Symbol\";\n  -webkit-font-smoothing: antialiased;\n  -moz-osx-font-smoothing: grayscale;\n  text-align: center;\n  color: #212529;\n}\n.group-list__wrapper *, .group-list__wrapper ::after, .group-list__wrapper ::before {\n  box-sizing: border-box;\n}\n.group-list__wrapper .table {\n  width: 100%;\n  max-width: 100%;\n  border-collapse: collapse;\n  text-align: left;\n}\n.group-list__wrapper .table thead th {\n  vertical-align: bottom;\n  border-bottom: 2px solid #dee2e6;\n  padding: 0.75rem;\n  border-top: 1px solid #dee2e6;\n}\n.group-list__wrapper .table th, .group-list__wrapper .table td {\n  padding: 0.75rem;\n  vertical-align: top;\n  border-top: 1px solid #dee2e6;\n}\n.group-list__wrapper .table td:last-of-type {\n  white-space: nowrap;\n}\n.group-list__wrapper .permissions {\n  font-size: 0.8rem;\n  font-family: Consolas, \"Andale Mono WT\", \"Andale Mono\", \"Lucida Console\", \"Lucida Sans Typewriter\", \"DejaVu Sans Mono\", \"Bitstream Vera Sans Mono\", \"Liberation Mono\", \"Nimbus Mono L\", Monaco, \"Courier New\", Courier, monospace;\n}\n.group-list__wrapper .btn {\n  border-radius: 2px;\n  padding: 0.5rem 1rem;\n  line-height: 1.5rem;\n  font-size: 1rem;\n  font-weight: bold;\n  border: none;\n  margin-bottom: 20px;\n  color: #fff;\n}\n.group-list__wrapper .btn-small {\n  margin-bottom: 0px;\n  padding: 0.1rem 0.3rem;\n  line-height: 0.8rem;\n  font-size: 0.8rem;\n  font-weight: normal;\n}\n.group-list__wrapper .btn-secondary {\n  background: transparent;\n  border: solid 1px #fa225b;\n  color: #fa225b;\n}\n.group-list__wrapper .btn.btn-secondary:hover {\n  box-shadow: 0 0 4px 1px rgba(250, 34, 91, 0.1);\n}\n.group-list__wrapper .btn:hover {\n  cursor: pointer;\n  box-shadow: 0 0 10px 4px rgba(250, 34, 91, 0.1);\n}\n.group-list__wrapper .btn:focus {\n  outline: 0;\n}\n\n/*# sourceMappingURL=GroupList.vue.map */", map: {"version":3,"sources":["/Users/dylanspurgin/dev/apitoolbox-ui/src/elements/GroupList/GroupList.vue","GroupList.vue"],"names":[],"mappings":"AAiIA;EACA,iKAAA;EACA,mCAAA;EACA,kCAAA;EACA,kBAAA;EACA,cAAA;AChIA;ADkIA;EACA,sBAAA;AChIA;ADmIA;EACA,WAAA;EACA,eAAA;EACA,yBAAA;EACA,gBAAA;ACjIA;ADmIA;EACA,sBAAA;EACA,gCAAA;EACA,gBAAA;EACA,6BAAA;ACjIA;ADmIA;EACA,gBAAA;EACA,mBAAA;EACA,6BAAA;ACjIA;ADoIA;EACA,mBAAA;AClIA;ADqIA;EACA,iBAAA;EACA,iOAAA;ACnIA;ADsIA;EACA,kBAAA;EACA,oBAAA;EACA,mBAAA;EACA,eAAA;EACA,iBAAA;EACA,YAAA;EACA,mBAAA;EACA,WAAA;ACpIA;ADsIA;EACA,kBAAA;EACA,sBAAA;EACA,mBAAA;EACA,iBAAA;EACA,mBAAA;ACpIA;ADsIA;EACA,uBAAA;EACA,yBAAA;EACA,cAAA;ACpIA;ADsIA;EACA,8CAAA;ACpIA;ADsIA;EACA,eAAA;EACA,+CAAA;ACpIA;ADsIA;EACA,UAAA;ACpIA;;AAEA,wCAAwC","file":"GroupList.vue","sourcesContent":["<template>\n    <div class=\"group-list__wrapper container\">\n        <div class=\"row justify-content-sm-end\">\n            <div class=\"col col-sm-6 d-flex justify-content-start\">\n                <h3>Groups</h3>\n            </div>\n            <div class=\"col col-sm-6 d-flex justify-content-end\">\n                <button class=\"btn btn-primary\" v-on:click=\"onAddGroupClick\">Add Group</button>\n            </div>\n        </div>\n        <div class=\"row mt-4\">\n            <div class=\"col\">\n                <table class=\"table table-striped table-responsive-xs\">\n                    <thead>\n                        <tr>\n                            <th>Name</th>\n                            <th width=\"1\">Actions</th>\n                        </tr>\n                    </thead>\n                    <tbody>\n                        <template v-if=\"groups.length && !loading\">\n                            <tr v-for=\"group in groups\" v-bind:key=\"group.id\">\n                                <td>{{group.name}}</td>\n                                <td>\n                                    <button class=\"btn btn-secondary btn-small\" v-on:click=\"onViewClick(group)\">View</button>\n                                    <button class=\"btn btn-secondary btn-small\" v-on:click=\"onEditClick(group)\">Edit</button>\n                                    <button class=\"btn btn-secondary btn-small\" v-on:click=\"onDeleteClick(group)\">Delete</button>\n                                </td>\n                            </tr>\n                        </template>\n                        <tr v-if=\"!groups.length && !loading\">\n                            <td colspan=\"3\" class=\"text-center\">No data</td>\n                        </tr>\n                        <tr v-if=\"loading\">\n                            <td colspan=\"3\" class=\"text-center\">Loading...</td>\n                        </tr>\n                </tbody>\n                </table>\n            </div>\n        </div>\n        <group-edit-modal \n            :server=\"server\"\n            :group-id=\"groupToEdit.id\"\n            :open-modal=\"openModal\">\n        </group-edit-modal>\n    </div>\n</template>\n\n<script>\n    import GroupEditModal from '../GroupEditModal/GroupEditModal.vue'\n    export default {\n        name: 'GroupList',\n        props: {\n            server: String\n        },\n        data: () => {\n            return {\n                groups: [],\n                loading:false,\n                openModal: false,\n                groupToEdit: {}\n            }\n        },\n        created () {\n            this.loading = true;\n            fetch(`${this.server}/auth/groups`)\n                .then( res =>res.json())\n                .then(groups => {\n                    this.loading = false;\n                    this.groups = groups.sort(groupSort);\n                })\n                .catch(err=>{\n                    this.loading = false;\n                    console.debug('Error retrieving group list or parsing response', err)\n                });\n\n            document.addEventListener('group-created.at', (e, p) => {\n                this.groups.push(e.detail.group);\n                this.groups.sort(groupSort);\n            });\n\n            document.addEventListener('group-edited.at', (e, p) => {\n                Object.assign(this.groups.find(group => group.id === e.detail.group.id), e.detail.group);\n            });\n        },\n        methods: {\n            onAddGroupClick () {\n                this.groupToEdit = {};\n                this.openModal = false;\n                window.setTimeout(() => {\n                    this.openModal = true;    \n                });\n            },\n            onViewClick (group) {\n                let event = new CustomEvent('group-view.at', {detail: {group: group}});\n                this.$el.parentNode.dispatchEvent(event);\n            },\n            onEditClick (group) {\n                this.groupToEdit = group;\n                this.openModal = false;\n                window.setTimeout(() => {\n                    this.openModal = true;    \n                });\n            },\n            onModalClose () {\n                this.openModal = false;\n            },\n            onDeleteClick (group) {\n                fetch(`${this.server}/auth/groups/${group.id}`,{\n                    method:'DELETE'\n                })\n                    .then(groups => {\n                        this.groups = this.groups.filter(grp=>grp.id !== group.id);\n                    })\n                    .catch(err => {\n                        this.loading = false;\n                        console.debug('Error removing group or parsing response', err)\n                    })\n            }\n        },\n        components: {GroupEditModal}\n    }\n    function groupSort (a, b) {\n        return a.name.toLowerCase().localeCompare(b.name.toLowerCase());\n    }\n</script>\n\n<style lang=\"scss\">\n    \n    .group-list__wrapper {\n        font-family: -apple-system,BlinkMacSystemFont,\"Segoe UI\",Roboto,\"Helvetica Neue\",Arial,sans-serif,\"Apple Color Emoji\",\"Segoe UI Emoji\",\"Segoe UI Symbol\";\n        -webkit-font-smoothing: antialiased;\n        -moz-osx-font-smoothing: grayscale;\n        text-align: center;\n        color: #212529;\n\n        *, ::after, ::before {\n            box-sizing: border-box;\n        }\n        \n        .table {\n            width: 100%;\n            max-width: 100%;\n            border-collapse: collapse;\n            text-align: left;\n        }\n        .table thead th {\n            vertical-align: bottom;\n            border-bottom: 2px solid #dee2e6;\n            padding: .75rem;\n            border-top: 1px solid #dee2e6;\n        }\n        .table th, .table td {\n            padding: .75rem;\n            vertical-align: top;\n            border-top: 1px solid #dee2e6;\n        }\n\n        .table td:last-of-type{\n            white-space: nowrap;\n        }\n\n        .permissions {\n            font-size: .8rem;\n            font-family: Consolas, \"Andale Mono WT\", \"Andale Mono\", \"Lucida Console\", \"Lucida Sans Typewriter\", \"DejaVu Sans Mono\", \"Bitstream Vera Sans Mono\", \"Liberation Mono\", \"Nimbus Mono L\", Monaco, \"Courier New\", Courier, monospace;\n        }\n\n        .btn {\n            border-radius: 2px;\n            padding: .5rem 1rem;\n            line-height: 1.5rem;\n            font-size: 1rem;\n            font-weight: bold;\n            border: none;\n            margin-bottom: 20px;\n            color: #fff;\n        }\n        .btn-small {\n            margin-bottom: 0px;\n            padding: .1rem .3rem;\n            line-height: .8rem;\n            font-size: .8rem;\n            font-weight: normal;\n        }\n        .btn-secondary {\n            background: transparent;\n            border: solid 1px #fa225b;\n            color: #fa225b;\n        }\n        .btn.btn-secondary:hover {\n            box-shadow: 0 0 4px 1px rgba(250, 34, 91, 0.1);\n        }\n        .btn:hover {\n            cursor: pointer;\n            box-shadow: 0 0 10px 4px rgba(250, 34, 91, 0.1);\n        }\n        .btn:focus {\n            outline: 0;\n        }\n    }\n</style>\n",".group-list__wrapper {\n  font-family: -apple-system, BlinkMacSystemFont, \"Segoe UI\", Roboto, \"Helvetica Neue\", Arial, sans-serif, \"Apple Color Emoji\", \"Segoe UI Emoji\", \"Segoe UI Symbol\";\n  -webkit-font-smoothing: antialiased;\n  -moz-osx-font-smoothing: grayscale;\n  text-align: center;\n  color: #212529;\n}\n.group-list__wrapper *, .group-list__wrapper ::after, .group-list__wrapper ::before {\n  box-sizing: border-box;\n}\n.group-list__wrapper .table {\n  width: 100%;\n  max-width: 100%;\n  border-collapse: collapse;\n  text-align: left;\n}\n.group-list__wrapper .table thead th {\n  vertical-align: bottom;\n  border-bottom: 2px solid #dee2e6;\n  padding: 0.75rem;\n  border-top: 1px solid #dee2e6;\n}\n.group-list__wrapper .table th, .group-list__wrapper .table td {\n  padding: 0.75rem;\n  vertical-align: top;\n  border-top: 1px solid #dee2e6;\n}\n.group-list__wrapper .table td:last-of-type {\n  white-space: nowrap;\n}\n.group-list__wrapper .permissions {\n  font-size: 0.8rem;\n  font-family: Consolas, \"Andale Mono WT\", \"Andale Mono\", \"Lucida Console\", \"Lucida Sans Typewriter\", \"DejaVu Sans Mono\", \"Bitstream Vera Sans Mono\", \"Liberation Mono\", \"Nimbus Mono L\", Monaco, \"Courier New\", Courier, monospace;\n}\n.group-list__wrapper .btn {\n  border-radius: 2px;\n  padding: 0.5rem 1rem;\n  line-height: 1.5rem;\n  font-size: 1rem;\n  font-weight: bold;\n  border: none;\n  margin-bottom: 20px;\n  color: #fff;\n}\n.group-list__wrapper .btn-small {\n  margin-bottom: 0px;\n  padding: 0.1rem 0.3rem;\n  line-height: 0.8rem;\n  font-size: 0.8rem;\n  font-weight: normal;\n}\n.group-list__wrapper .btn-secondary {\n  background: transparent;\n  border: solid 1px #fa225b;\n  color: #fa225b;\n}\n.group-list__wrapper .btn.btn-secondary:hover {\n  box-shadow: 0 0 4px 1px rgba(250, 34, 91, 0.1);\n}\n.group-list__wrapper .btn:hover {\n  cursor: pointer;\n  box-shadow: 0 0 10px 4px rgba(250, 34, 91, 0.1);\n}\n.group-list__wrapper .btn:focus {\n  outline: 0;\n}\n\n/*# sourceMappingURL=GroupList.vue.map */"]}, media: undefined });
  ...
  var __vue_render__$4 = function() {
    ...
    return _c(
      "div",
      { staticClass: "group-view__wrapper container" },
      [
        _c("div", { staticClass: "row" }, [
          ...
          _c("div", { staticClass: "col-8 d-flex justify-content-end" }, [
            _c(
              "button",
              { staticClass: "btn btn-primary", on: { click: _vm.onEditClick } },
              [_vm._v("Edit")]
            )
          ])
        ]),
        ...
        _c("div", { staticClass: "row py-2" }, [
          _c(
            "div",
            { staticClass: "col-4 d-flex justify-content-end font-weight-bold" },
            [_vm._v("\n            Permissions\n        ")]
          ),
          _vm._v(" "),
              ...
              ? _c(
                  ...
                  _vm._l(_vm.permissions, function(permission) {
                    return _c("li", { staticClass: "list-group-item" }, [
                      _vm._v(_vm._s(permission.alias))
                    ])
                  }),
                  0
                )
        ...
        _c("div", { staticClass: "row py-2" }, [
          ...
          _c("div", { staticClass: "col-8 d-flex justify-content-start" }, [
            _vm._v(
              "\n            " +
                _vm._s(_vm._f("dateTimeFormat")(_vm.group.created_at)) +
                "\n        "
            )
          ])
        ]),
        ...
        _c("div", { staticClass: "row py-2" }, [
          ...
          _c("div", { staticClass: "col-8 d-flex justify-content-start" }, [
            _vm._v(
              "\n            " +
                _vm._s(_vm._f("dateTimeFormat")(_vm.group.updated_at)) +
                "\n        "
            )
          ])
        ]),
        _vm._v(" "),
        _c("group-edit-modal", {
          attrs: { "group-id": _vm.group.id, "open-modal": _vm.openModal }
        })
      ],
      1
    )
  ...
  __vue_render__$4._withStripped = true;
    ...
    const __vue_inject_styles__$4 = function (inject) {
      if (!inject) return
      inject("data-v-d8816126_0", { source: ".group-view__wrapper {\n  font-family: -apple-system, BlinkMacSystemFont, \"Segoe UI\", Roboto, \"Helvetica Neue\", Arial, sans-serif, \"Apple Color Emoji\", \"Segoe UI Emoji\", \"Segoe UI Symbol\";\n  -webkit-font-smoothing: antialiased;\n  -moz-osx-font-smoothing: grayscale;\n  color: #212529;\n}\n.group-view__wrapper *, .group-view__wrapper ::after, .group-view__wrapper ::before {\n  box-sizing: border-box;\n}\n\n/*# sourceMappingURL=GroupView.vue.map */", map: {"version":3,"sources":["/Users/dylanspurgin/dev/apitoolbox-ui/src/elements/GroupView/GroupView.vue","GroupView.vue"],"names":[],"mappings":"AAoHA;EACA,iKAAA;EACA,mCAAA;EACA,kCAAA;EACA,cAAA;ACnHA;ADqHA;EACA,sBAAA;ACnHA;;AAEA,wCAAwC","file":"GroupView.vue","sourcesContent":["<template>\n    <div class=\"group-view__wrapper container\">\n        <div class=\"row\">\n            <div class=\"col-4 d-flex justify-content-end\">\n                <h3>{{group.name}}</h3>\n            </div>\n            <div class=\"col-8 d-flex justify-content-end\"><button class=\"btn btn-primary\" v-on:click=\"onEditClick\">Edit</button></div>\n        </div>\n\n        <div class=\"row py-2\">\n            <div class=\"col-4 d-flex justify-content-end font-weight-bold\">\n                Permissions\n            </div>\n            <div class=\"col-8 d-flex justify-content-start\">\n                <ul v-if=\"permissions\" class=\"list-group\">\n                    <li v-for=\"permission in permissions\" class=\"list-group-item\">{{permission.alias}}</li>\n                </ul>\n            </div>\n        </div>\n\n        <div class=\"row py-2\">\n            <div class=\"col-4 d-flex justify-content-end font-weight-bold\">\n                Created at\n            </div>\n            <div class=\"col-8 d-flex justify-content-start\">\n                {{group.created_at | dateTimeFormat}}\n            </div>\n        </div>\n\n        <div class=\"row py-2\">\n            <div class=\"col-4 d-flex justify-content-end font-weight-bold\">\n                Last updated at\n            </div>\n            <div class=\"col-8 d-flex justify-content-start\">\n                {{group.updated_at | dateTimeFormat}}\n            </div>\n        </div>\n\n        <group-edit-modal \n            :group-id=\"group.id\" \n            :open-modal=\"openModal\">\n        </group-edit-modal>\n    </div>\n</template>\n<script>\n    import GroupEditModal from '../GroupEditModal/GroupEditModal.vue';\n    import '../../filters/date-time-format.filter.js';\n    export default {\n        name: 'GroupView',\n        props: {\n            server: String,\n            groupId: String\n        },\n        data: () => {\n            return {\n                openModal: false,\n                group: {},\n                permissions: []\n            };\n        },\n        created () {\n            // TODO - this group\n            document.addEventListener('group-edited.at', (e, p) => {\n                console.debug('group-edited.at', e);\n                // Object.assign(this.users.find(user => user.id === e.detail.user.id), e.detail.user);\n            });\n        },\n        watch: {\n            groupId: function (val) {\n                if (val) {\n                    this.fetchGroup();\n                    this.fetchGroupPermissions();\n                }\n            }\n        },\n        methods: {\n            fetchGroup () {\n                fetch(`${this.server}/auth/groups/${this.groupId}`)\n                    .then(this.handleResponse)\n                    .then(group => {\n                        this.group = group;\n                    });\n            },\n            fetchGroupPermissions () {\n                fetch(`${this.server}/auth/groups/${this.groupId}/permissions`)\n                    .then(this.handleResponse)\n                    .then(permissions => {\n                        this.permissions = permissions;\n                        console.debug('permissions', this.permissions);\n                    });\n            },\n            handleResponse (response) {\n                return response.json()\n                    .then((json) => {\n                        if (!response.ok) {\n                            const error = Object.assign({}, json, {\n                                status: response.status,\n                                statusText: response.statusText,\n                            });\n                            return Promise.reject(error);\n                        }\n                        return json;\n                    });\n            },\n            onEditClick () {\n                this.openModal = false;\n                window.setTimeout(() => {\n                    this.openModal = true;\n                });\n            }\n        },\n        components: {GroupEditModal}\n    }\n</script>\n\n<style lang=\"scss\">\n    .group-view__wrapper {\n        font-family: -apple-system,BlinkMacSystemFont,\"Segoe UI\",Roboto,\"Helvetica Neue\",Arial,sans-serif,\"Apple Color Emoji\",\"Segoe UI Emoji\",\"Segoe UI Symbol\";\n        -webkit-font-smoothing: antialiased;\n        -moz-osx-font-smoothing: grayscale;\n        color: #212529;\n\n        *, ::after, ::before {\n            box-sizing: border-box;\n        }\n    }\n</style>\n",".group-view__wrapper {\n  font-family: -apple-system, BlinkMacSystemFont, \"Segoe UI\", Roboto, \"Helvetica Neue\", Arial, sans-serif, \"Apple Color Emoji\", \"Segoe UI Emoji\", \"Segoe UI Symbol\";\n  -webkit-font-smoothing: antialiased;\n  -moz-osx-font-smoothing: grayscale;\n  color: #212529;\n}\n.group-view__wrapper *, .group-view__wrapper ::after, .group-view__wrapper ::before {\n  box-sizing: border-box;\n}\n\n/*# sourceMappingURL=GroupView.vue.map */"]}, media: undefined });
  ...
  var __vue_render__$5 = function() {
    ...
    return _c(
      "div",
      { staticClass: "login-form__wrapper", style: _vm.formStyle },
      [
    ...
    return _c(
      ...
      [
        _c(
          ...
          {
            ref: "modalWrapper",
            staticClass: "modal-window permission-edit-modal"
          },
          [
            _c("div", { ref: "modal", staticClass: "modal fade" }, [
              _c(
                ...
                [
                  _c("div", { staticClass: "modal-content" }, [
                    _c("header", { staticClass: "modal-header" }, [
                      !_vm.permissionId
                        ? _c("h3", [_vm._v("Add Permission")])
                        : _vm._e(),
                      _vm._v(" "),
                      _vm.permissionId
                        ? _c("h3", [_vm._v("Edit Permission")])
                        : _vm._e()
                    ]),
                    _vm._v(" "),
                    _c("main", { staticClass: "modal-body" }, [
                            ...
                            _c(
                              ...
                              [
                                _c("div", { staticClass: "form-group" }, [
                                    ...
                                    directives: [
                                      {
                                        name: "model",
                                        rawName: "v-model",
                                        value: _vm.permissionToEdit.alias,
                                        expression: "permissionToEdit.alias"
                                      }
                                    ],
                                    ref: "alias",
                                    staticClass: "form-control",
                                  ...
                                  _c("div", { staticClass: "invalid-feedback" }, [
                                    _vm._v(
                                      "Please provide a human-readable alias for the permission. Eg; Read all users."
                                    )
                                  ])
                                ]),
                                _vm._v(" "),
                                _c("div", { staticClass: "form-group" }, [
                                    ...
                                    directives: [
                                      {
                                        name: "model",
                                        rawName: "v-model",
                                        value: _vm.permissionToEdit.name,
                                        expression: "permissionToEdit.name"
                                      }
                                    ],
                                    ref: "name",
                                    staticClass: "form-control",
                                  ...
                                  _c("div", { staticClass: "invalid-feedback" }, [
                                    _vm._v(
                                      "Please provide a permission string in the format OBJECT.ID.ACTION. Eg; USERS.*.READ"
                                    )
                                  ])
                                ])
                              ]
  ...
  __vue_render__$6._withStripped = true;
    ...
    const __vue_inject_styles__$6 = function (inject) {
      if (!inject) return
      inject("data-v-13e1e9ef_0", { source: ".permission-edit-modal {\n  position: fixed;\n  top: 0;\n  left: 0;\n  width: 100%;\n  height: 100%;\n  z-index: 999;\n  background-color: rgba(0, 0, 0, 0.4);\n  transition: all 0.3s;\n}\n.permission-edit-modal *, .permission-edit-modal ::after, .permission-edit-modal ::before {\n  box-sizing: border-box;\n}\n.permission-edit-modal .modal {\n  display: block;\n}\n.permission-edit-modal .modal-dialog {\n  max-width: 500px;\n  position: relative;\n  margin: 1.75rem auto;\n  transition: transform 0.3s ease-out;\n}\n.permission-edit-modal .modal-content {\n  height: auto;\n  background: #ffffff;\n  pointer-events: all;\n}\n.permission-edit-modal .form-control:focus {\n  outline: 0;\n}\n.permission-edit-modal .modal-footer {\n  display: flex;\n  justify-content: flex-end;\n}\n\n/*# sourceMappingURL=PermissionEditModal.vue.map */", map: {"version":3,"sources":["/Users/dylanspurgin/dev/apitoolbox-ui/src/elements/PermissionEditModal/PermissionEditModal.vue","PermissionEditModal.vue"],"names":[],"mappings":"AA6LA;EACA,eAAA;EACA,MAAA;EACA,OAAA;EACA,WAAA;EACA,YAAA;EACA,YAAA;EACA,oCAAA;EACA,oBAAA;AC5LA;AD6LA;EACA,sBAAA;AC3LA;AD6LA;EACA,cAAA;AC3LA;AD6LA;EACA,gBAAA;EACA,kBAAA;EACA,oBAAA;EACA,mCAAA;AC3LA;AD6LA;EACA,YAAA;EACA,mBAAA;EACA,mBAAA;AC3LA;AD8LA;EACA,UAAA;AC5LA;AD8LA;EACA,aAAA;EACA,yBAAA;AC5LA;;AAEA,kDAAkD","file":"PermissionEditModal.vue","sourcesContent":["<template>\n    <div v-show=\"false\" ref=\"modalTemplate\">\n        <div class=\"modal-window permission-edit-modal\" ref=\"modalWrapper\">\n            <div class=\"modal fade\" ref=\"modal\">\n                <div class=\"modal-dialog modal-md modal-dialog-scrollable\">\n                    <div class=\"modal-content\">\n                        <header class=\"modal-header\">\n                            <h3 v-if=\"!permissionId\">Add Permission</h3>\n                            <h3 v-if=\"permissionId\">Edit Permission</h3>\n                        </header>\n                        <main class=\"modal-body\">\n                            <div class=\"container-fluid\">\n                                <div class=\"row\">\n                                    <div class=\"col\">\n                                        <form class=\"form needs-validation\" ref=\"form\" novalidate>\n                                            <div class=\"form-group\">\n                                                <label for=\"alias\">Alias</label>\n                                                <input\n                                                    type=\"text\"\n                                                    class=\"form-control\"\n                                                    id=\"alias\"\n                                                    name=\"alias\"\n                                                    placeholder=\"Alias\"\n                                                    ref=\"alias\"\n                                                    v-model=\"permissionToEdit.alias\"\n                                                    :required=\"true\">\n                                                <div class=\"invalid-feedback\">Please provide a human-readable alias for the permission. Eg; Read all users.</div>\n                                            </div>\n                                            <div class=\"form-group\">\n                                                <label for=\"name\">Name</label>\n                                                <input\n                                                    type=\"text\"\n                                                    class=\"form-control\"\n                                                    id=\"name\"\n                                                    name=\"name\"\n                                                    placeholder=\"Name\"\n                                                    ref=\"name\"\n                                                    v-model=\"permissionToEdit.name\"\n                                                    :required=\"true\">\n                                                <div class=\"invalid-feedback\">Please provide a permission string in the format OBJECT.ID.ACTION. Eg; USERS.*.READ</div>\n                                            </div>\n                                        </form>\n                                    </div>\n                                </div>\n                            </div>\n                        </main>\n                        <footer class=\"modal-footer\">\n                            <button v-on:click=\"onCancelClick\" class=\"btn btn-secondary\">\n                                Cancel\n                            </button>\n                            <button\n                                v-on:click=\"onSaveClick\"\n                                class=\"btn btn-primary\"\n                            >\n                                Save\n                            </button>\n                        </footer>\n                    </div>\n                </div>\n            </div>\n        </div>\n    </div>\n</template>\n\n<script>\nexport default {\n    name: \"PermissionEditModal\",\n    props: {\n        server: {\n            type: String,\n            default: ''\n        },\n        openModal: Boolean, // Requested modal state\n        permissionId: String\n    },\n    data: () => {\n        return {\n            permissionToEdit: {},\n            isOpen: false // Actual modal state\n        };\n    },\n    watch: {\n        openModal: function(val) {\n            if (val === this.isOpen) {\n                // Already in requested state\n                return;\n            }\n            if (val) {\n                if (this.permissionId) {\n                    this.fetchPermission(this.permissionId)\n                        .then(permission => {\n                            this.permissionToEdit = {};\n                            console.debug('this', this);\n                            console.debug('this.permissionToEdit', this.permissionToEdit);\n                            console.debug('permission to edit', permission);\n                            Object.assign(this.permissionToEdit, permission);\n                        });\n                }\n                this.open();\n            } else {\n                this.close();\n            }\n        }\n    },\n    methods: {\n        onCancelClick() {\n            this.close();\n        },\n        onSaveClick() {\n            if (this.$refs.form.checkValidity() === false) {\n                this.$refs.form.classList.add('was-validated');\n                return;\n            }\n            let request;\n            if (this.permissionId) {\n                request = fetch(`${this.server}/auth/permissions/${this.permissionId}`, {\n                    method: \"PUT\",\n                    headers: {\n                        \"Content-Type\": \"application/json\"\n                    },\n                    body: JSON.stringify(this.permissionToEdit)\n                });\n            } else {\n                request = fetch(`${this.server}/auth/permissions`, {\n                    method: \"POST\",\n                    headers: {\n                        \"Content-Type\": \"application/json\"\n                    },\n                    body: JSON.stringify(this.permissionToEdit)\n                });\n            }\n            request\n                .then(this.handleResponse)\n                .then(permission=>{\n                    let event;\n                    if (this.permissionToEdit.id) {\n                        event = new CustomEvent('permission-edited.ft', {detail: {permission}})\n                    } else {\n                        event = new CustomEvent('permission-created.ft', {detail: {permission}})\n                    }\n                    document.dispatchEvent(event);\n                })\n                .catch(err=>{\n                    console.debug('Error creating permission or parsing response', err)\n                })\n            this.close();\n        },\n        fetchPermission (id) {\n            return fetch(`${this.server}/auth/permissions/${id}`)\n                .then(this.handleResponse)\n                .catch(e => {\n                    console.error('Error fetching permission', e);\n                });\n        },\n        handleResponse (response) {\n            return response.json()\n                .then((json) => {\n                    if (!response.ok) {\n                        const error = Object.assign({}, json, {\n                            status: response.status,\n                            statusText: response.statusText,\n                        });\n\n                        return Promise.reject(error);\n                    }\n                    return json;\n                });\n        },\n        open () {\n            document.body.appendChild(this.$refs.modalWrapper);\n            window.setTimeout(() => {\n                this.$refs.modal.classList.add('show');    \n            }, 100);\n            \n            this.isOpen = true;\n        },\n        close () {\n            this.$refs.modal.classList.remove('show');\n            this.$refs.form.classList.remove('was-validated');\n            window.setTimeout(() => {\n                this.$refs.modalTemplate.appendChild(this.$refs.modalWrapper);\n            }, 300);\n            this.isOpen = false;\n        }\n    }\n};\n</script>\n\n<style lang=\"scss\">\n    .permission-edit-modal {\n        position: fixed;\n        top: 0;\n        left: 0;\n        width: 100%;\n        height: 100%;\n        z-index: 999;\n        background-color: rgba(0, 0, 0, .4);\n        transition: all 0.3s;\n        *, ::after, ::before {\n            box-sizing: border-box;\n        }\n        .modal {\n            display: block;\n        }\n        .modal-dialog {\n            max-width: 500px;\n            position: relative;\n            margin: 1.75rem auto;\n            transition: transform .3s ease-out;\n        }\n        .modal-content {\n            height: auto;\n            background: #ffffff;\n            pointer-events: all;\n        }\n\n        .form-control:focus {\n            outline: 0;\n        }\n        .modal-footer {\n            display: flex;\n            justify-content: flex-end;\n        }\n    }\n</style>\n",".permission-edit-modal {\n  position: fixed;\n  top: 0;\n  left: 0;\n  width: 100%;\n  height: 100%;\n  z-index: 999;\n  background-color: rgba(0, 0, 0, 0.4);\n  transition: all 0.3s;\n}\n.permission-edit-modal *, .permission-edit-modal ::after, .permission-edit-modal ::before {\n  box-sizing: border-box;\n}\n.permission-edit-modal .modal {\n  display: block;\n}\n.permission-edit-modal .modal-dialog {\n  max-width: 500px;\n  position: relative;\n  margin: 1.75rem auto;\n  transition: transform 0.3s ease-out;\n}\n.permission-edit-modal .modal-content {\n  height: auto;\n  background: #ffffff;\n  pointer-events: all;\n}\n.permission-edit-modal .form-control:focus {\n  outline: 0;\n}\n.permission-edit-modal .modal-footer {\n  display: flex;\n  justify-content: flex-end;\n}\n\n/*# sourceMappingURL=PermissionEditModal.vue.map */"]}, media: undefined });
  ...
  var script$7 = {
      ...
      created () {
          ...
          fetch(`${this.server}/auth/permissions`)
              ...
              .then(permissions => {
                  this.loading = false;
                  this.permissions = permissions;
                  this.permissions.sort(permissionSort$1);
              })
              .catch(err=>{
                  this.loading = false;
      ...
      components: {PermissionEditModal: __vue_component__$6}
  };
  function permissionSort$1 (a, b) {
      return a.alias.toLowerCase().localeCompare(b.alias.toLowerCase());
  }
  ...
  var __vue_render__$7 = function() {
    ...
    return _c(
      "div",
      { staticClass: "permission-list__wrapper" },
      [
        _c("div", { staticClass: "row" }, [
          _vm._m(0),
          _vm._v(" "),
          _c("div", { staticClass: "col col-sm-6 d-flex justify-content-end" }, [
            _c(
              ...
              {
                staticClass: "btn btn-primary",
                on: { click: _vm.onAddPermissionClick }
              },
            ...
            _c(
              ...
              [
                ...
                _c(
                  "tbody",
                  [
                    _vm.permissions.length && !_vm.loading
                      ? _vm._l(_vm.permissions, function(permission) {
                          return _c("tr", { key: permission.id }, [
                            _c("td", [_vm._v(_vm._s(permission.alias))]),
                            _vm._v(" "),
                            ...
                            _c("td", [
                              _c(
                                "button",
                                {
                                  ...
                                  on: {
                                    click: function($event) {
                                      return _vm.onEditClick(permission)
                                    }
                                  }
                                },
                                [_vm._v("Edit")]
                              ...
                              _c(
                                "button",
                                {
                                  ...
                                  on: {
                                    click: function($event) {
                                      return _vm.onDeleteClick(permission)
                                    }
                                  }
                                },
                                [_vm._v("Delete")]
        ...
        _vm._v(" "),
        _c("permission-edit-modal", {
          attrs: {
            server: _vm.server,
            "permission-id": _vm.permissionToEdit.id,
            "open-modal": _vm.openModal
          }
        })
      ],
  ...
  __vue_render__$7._withStripped = true;
    ...
    const __vue_inject_styles__$7 = function (inject) {
      if (!inject) return
      inject("data-v-b37c7d98_0", { source: ".permission-list__wrapper {\n  font-family: -apple-system, BlinkMacSystemFont, \"Segoe UI\", Roboto, \"Helvetica Neue\", Arial, sans-serif, \"Apple Color Emoji\", \"Segoe UI Emoji\", \"Segoe UI Symbol\";\n  -webkit-font-smoothing: antialiased;\n  -moz-osx-font-smoothing: grayscale;\n  text-align: center;\n  color: #212529;\n}\n.permission-list__wrapper *, .permission-list__wrapper ::after, .permission-list__wrapper ::before {\n  box-sizing: border-box;\n}\n.permission-list__wrapper .table {\n  width: 100%;\n  max-width: 100%;\n  border-collapse: collapse;\n  text-align: left;\n}\n.permission-list__wrapper .table thead th {\n  vertical-align: bottom;\n  border-bottom: 2px solid #dee2e6;\n  padding: 0.75rem;\n  border-top: 1px solid #dee2e6;\n}\n.permission-list__wrapper .table th, .permission-list__wrapper .table td {\n  padding: 0.75rem;\n  vertical-align: top;\n  border-top: 1px solid #dee2e6;\n}\n.permission-list__wrapper .table td:last-of-type {\n  white-space: nowrap;\n}\n.permission-list__wrapper .permissions {\n  font-size: 0.8rem;\n  font-family: Consolas, \"Andale Mono WT\", \"Andale Mono\", \"Lucida Console\", \"Lucida Sans Typewriter\", \"DejaVu Sans Mono\", \"Bitstream Vera Sans Mono\", \"Liberation Mono\", \"Nimbus Mono L\", Monaco, \"Courier New\", Courier, monospace;\n}\n.permission-list__wrapper .btn {\n  border-radius: 2px;\n  padding: 0.5rem 1rem;\n  line-height: 1.5rem;\n  font-size: 1rem;\n  font-weight: bold;\n  border: none;\n  margin-bottom: 20px;\n  color: #fff;\n}\n.permission-list__wrapper .btn-small {\n  margin-bottom: 0px;\n  padding: 0.1rem 0.3rem;\n  line-height: 0.8rem;\n  font-size: 0.8rem;\n  font-weight: normal;\n}\n.permission-list__wrapper .btn-secondary {\n  background: transparent;\n  border: solid 1px #fa225b;\n  color: #fa225b;\n}\n.permission-list__wrapper .btn.btn-secondary:hover {\n  box-shadow: 0 0 4px 1px rgba(250, 34, 91, 0.1);\n}\n.permission-list__wrapper .btn:hover {\n  cursor: pointer;\n  box-shadow: 0 0 10px 4px rgba(250, 34, 91, 0.1);\n}\n.permission-list__wrapper .btn:focus {\n  outline: 0;\n}\n\n/*# sourceMappingURL=PermissionList.vue.map */", map: {"version":3,"sources":["/Users/dylanspurgin/dev/apitoolbox-ui/src/elements/PermissionList/PermissionList.vue","PermissionList.vue"],"names":[],"mappings":"AA+HA;EACA,iKAAA;EACA,mCAAA;EACA,kCAAA;EACA,kBAAA;EACA,cAAA;AC9HA;ADgIA;EACA,sBAAA;AC9HA;ADiIA;EACA,WAAA;EACA,eAAA;EACA,yBAAA;EACA,gBAAA;AC/HA;ADiIA;EACA,sBAAA;EACA,gCAAA;EACA,gBAAA;EACA,6BAAA;AC/HA;ADiIA;EACA,gBAAA;EACA,mBAAA;EACA,6BAAA;AC/HA;ADkIA;EACA,mBAAA;AChIA;ADmIA;EACA,iBAAA;EACA,iOAAA;ACjIA;ADoIA;EACA,kBAAA;EACA,oBAAA;EACA,mBAAA;EACA,eAAA;EACA,iBAAA;EACA,YAAA;EACA,mBAAA;EACA,WAAA;AClIA;ADoIA;EACA,kBAAA;EACA,sBAAA;EACA,mBAAA;EACA,iBAAA;EACA,mBAAA;AClIA;ADoIA;EACA,uBAAA;EACA,yBAAA;EACA,cAAA;AClIA;ADoIA;EACA,8CAAA;AClIA;ADoIA;EACA,eAAA;EACA,+CAAA;AClIA;ADoIA;EACA,UAAA;AClIA;;AAEA,6CAA6C","file":"PermissionList.vue","sourcesContent":["<template>\n    <div class=\"permission-list__wrapper\">\n        <div class=\"row\">\n            <div class=\"col col-sm-6 d-flex justify-content-start\">\n                <h3>Permissions</h3>\n            </div>\n            <div class=\"col col-sm-6 d-flex justify-content-end\">\n                <button class=\"btn btn-primary\" v-on:click=\"onAddPermissionClick\">Add Permission</button>\n            </div>\n        </div>\n        <div class=\"row\">\n            <div class=\"col\">\n                <table class=\"table table-striped table-responsive-xs\">\n                    <thead>\n                        <tr>\n                            <th>Alias</th>\n                            <th>Name</th>\n                            <th width=\"1\">Actions</th>\n                        </tr>\n                    </thead>\n                    <tbody>\n                        <template v-if=\"permissions.length && !loading\">\n                            <tr v-for=\"permission in permissions\" v-bind:key=\"permission.id\">\n                                <td>{{permission.alias}}</td>\n                                <td>{{permission.name}}</td>\n                                <td>\n                                    <button class=\"btn btn-secondary btn-small\" v-on:click=\"onEditClick(permission)\">Edit</button>\n                                    <button class=\"btn btn-secondary btn-small\" v-on:click=\"onDeleteClick(permission)\">Delete</button>\n                                </td>\n                            </tr>\n                        </template>\n                        <tr v-if=\"!permissions.length && !loading\">\n                            <td colspan=\"3\" class=\"text-center\">No data</td>\n                        </tr>\n                        <tr v-if=\"loading\">\n                            <td colspan=\"3\" class=\"text-center\">Loading...</td>\n                        </tr>\n                </tbody>\n                </table>\n            </div>\n        </div>\n        <permission-edit-modal \n            :server=\"server\"\n            :permission-id=\"permissionToEdit.id\"\n            :open-modal=\"openModal\">\n        </permission-edit-modal>\n    </div>\n</template>\n\n<script>\n    import PermissionEditModal from '../PermissionEditModal/PermissionEditModal.vue'\n    export default {\n        name: 'PermissionList',\n        props: {\n            server: String\n        },\n        data: () => {\n            return {\n                permissions: [],\n                loading:false,\n                openModal: false,\n                permissionToEdit: {}\n            }\n        },\n        created () {\n            this.loading = true;\n            fetch(`${this.server}/auth/permissions`)\n                .then( res =>res.json())\n                .then(permissions => {\n                    this.loading = false;\n                    this.permissions = permissions;\n                    this.permissions.sort(permissionSort);\n                })\n                .catch(err=>{\n                    this.loading = false;\n                    console.debug('Error retrieving permission list or parsing response', err)\n                })\n\n            document.addEventListener('permission-created.ft', (e, p) => {\n                this.permissions.push(e.detail.permission);\n                this.permissions.sort(permissionSort);\n            })\n\n            document.addEventListener('permission-edited.ft', (e, p) => {\n                Object.assign(this.permissions.find(permission => permission.id === e.detail.permission.id), e.detail.permission);\n            })\n        },\n        methods: {\n            onAddPermissionClick () {\n                this.permissionToEdit = {};\n                this.openModal = false;\n                window.setTimeout(() => {\n                    this.openModal = true;    \n                });\n            },\n            onEditClick (permission) {\n                this.permissionToEdit = permission;\n                this.openModal = false;\n                window.setTimeout(() => {\n                    this.openModal = true;    \n                });\n            },\n            onModalClose () {\n                this.openModal = false;\n            },\n            onDeleteClick (permission) {\n                fetch(`${this.server}/auth/permissions/${permission.id}`,{\n                    method:'DELETE'\n                })\n                    .then(permissions => {\n                        this.permissions = this.permissions.filter(perm=>perm.id !== permission.id);\n                    })\n                    .catch(err => {\n                        this.loading = false;\n                        console.debug('Error removing permission or parsing response', err)\n                    })\n            }\n        },\n        components: {PermissionEditModal}\n    }\n    function permissionSort (a, b) {\n        return a.alias.toLowerCase().localeCompare(b.alias.toLowerCase());\n    }\n</script>\n\n<style lang=\"scss\">\n    \n    .permission-list__wrapper {\n        font-family: -apple-system,BlinkMacSystemFont,\"Segoe UI\",Roboto,\"Helvetica Neue\",Arial,sans-serif,\"Apple Color Emoji\",\"Segoe UI Emoji\",\"Segoe UI Symbol\";\n        -webkit-font-smoothing: antialiased;\n        -moz-osx-font-smoothing: grayscale;\n        text-align: center;\n        color: #212529;\n\n        *, ::after, ::before {\n            box-sizing: border-box;\n        }\n        \n        .table {\n            width: 100%;\n            max-width: 100%;\n            border-collapse: collapse;\n            text-align: left;\n        }\n        .table thead th {\n            vertical-align: bottom;\n            border-bottom: 2px solid #dee2e6;\n            padding: .75rem;\n            border-top: 1px solid #dee2e6;\n        }\n        .table th, .table td {\n            padding: .75rem;\n            vertical-align: top;\n            border-top: 1px solid #dee2e6;\n        }\n\n        .table td:last-of-type{\n            white-space: nowrap;\n        }\n\n        .permissions {\n            font-size: .8rem;\n            font-family: Consolas, \"Andale Mono WT\", \"Andale Mono\", \"Lucida Console\", \"Lucida Sans Typewriter\", \"DejaVu Sans Mono\", \"Bitstream Vera Sans Mono\", \"Liberation Mono\", \"Nimbus Mono L\", Monaco, \"Courier New\", Courier, monospace;\n        }\n\n        .btn {\n            border-radius: 2px;\n            padding: .5rem 1rem;\n            line-height: 1.5rem;\n            font-size: 1rem;\n            font-weight: bold;\n            border: none;\n            margin-bottom: 20px;\n            color: #fff;\n        }\n        .btn-small {\n            margin-bottom: 0px;\n            padding: .1rem .3rem;\n            line-height: .8rem;\n            font-size: .8rem;\n            font-weight: normal;\n        }\n        .btn-secondary {\n            background: transparent;\n            border: solid 1px #fa225b;\n            color: #fa225b;\n        }\n        .btn.btn-secondary:hover {\n            box-shadow: 0 0 4px 1px rgba(250, 34, 91, 0.1);\n        }\n        .btn:hover {\n            cursor: pointer;\n            box-shadow: 0 0 10px 4px rgba(250, 34, 91, 0.1);\n        }\n        .btn:focus {\n            outline: 0;\n        }\n    }\n</style>\n",".permission-list__wrapper {\n  font-family: -apple-system, BlinkMacSystemFont, \"Segoe UI\", Roboto, \"Helvetica Neue\", Arial, sans-serif, \"Apple Color Emoji\", \"Segoe UI Emoji\", \"Segoe UI Symbol\";\n  -webkit-font-smoothing: antialiased;\n  -moz-osx-font-smoothing: grayscale;\n  text-align: center;\n  color: #212529;\n}\n.permission-list__wrapper *, .permission-list__wrapper ::after, .permission-list__wrapper ::before {\n  box-sizing: border-box;\n}\n.permission-list__wrapper .table {\n  width: 100%;\n  max-width: 100%;\n  border-collapse: collapse;\n  text-align: left;\n}\n.permission-list__wrapper .table thead th {\n  vertical-align: bottom;\n  border-bottom: 2px solid #dee2e6;\n  padding: 0.75rem;\n  border-top: 1px solid #dee2e6;\n}\n.permission-list__wrapper .table th, .permission-list__wrapper .table td {\n  padding: 0.75rem;\n  vertical-align: top;\n  border-top: 1px solid #dee2e6;\n}\n.permission-list__wrapper .table td:last-of-type {\n  white-space: nowrap;\n}\n.permission-list__wrapper .permissions {\n  font-size: 0.8rem;\n  font-family: Consolas, \"Andale Mono WT\", \"Andale Mono\", \"Lucida Console\", \"Lucida Sans Typewriter\", \"DejaVu Sans Mono\", \"Bitstream Vera Sans Mono\", \"Liberation Mono\", \"Nimbus Mono L\", Monaco, \"Courier New\", Courier, monospace;\n}\n.permission-list__wrapper .btn {\n  border-radius: 2px;\n  padding: 0.5rem 1rem;\n  line-height: 1.5rem;\n  font-size: 1rem;\n  font-weight: bold;\n  border: none;\n  margin-bottom: 20px;\n  color: #fff;\n}\n.permission-list__wrapper .btn-small {\n  margin-bottom: 0px;\n  padding: 0.1rem 0.3rem;\n  line-height: 0.8rem;\n  font-size: 0.8rem;\n  font-weight: normal;\n}\n.permission-list__wrapper .btn-secondary {\n  background: transparent;\n  border: solid 1px #fa225b;\n  color: #fa225b;\n}\n.permission-list__wrapper .btn.btn-secondary:hover {\n  box-shadow: 0 0 4px 1px rgba(250, 34, 91, 0.1);\n}\n.permission-list__wrapper .btn:hover {\n  cursor: pointer;\n  box-shadow: 0 0 10px 4px rgba(250, 34, 91, 0.1);\n}\n.permission-list__wrapper .btn:focus {\n  outline: 0;\n}\n\n/*# sourceMappingURL=PermissionList.vue.map */"]}, media: undefined });
  ...
  var params_1 = params._setTarget;
  var params_2 = params.popParams;
  var params_3 = params.pushParams;
  var params_4 = params.target;
  var params_5 = params.withParams;
  ...
  var validators_3 = validators.and;
  var validators_4 = validators.between;
  var validators_5 = validators.decimal;
  var validators_6 = validators.email;
  var validators_7 = validators.helpers;
  var validators_8 = validators.integer;
  var validators_9 = validators.ipAddress;
  var validators_10 = validators.macAddress;
  var validators_11 = validators.maxLength;
  var validators_12 = validators.maxValue;
  var validators_13 = validators.minLength;
  var validators_14 = validators.minValue;
  var validators_15 = validators.not;
  var validators_16 = validators.numeric;
  var validators_17 = validators.or;
  var validators_18 = validators.required;
  var validators_19 = validators.requiredIf;
  var validators_20 = validators.requiredUnless;
  var validators_21 = validators.sameAs;
  var validators_22 = validators.url;
  ...
  var script$8 = {
      ...
      validations: {
          ...
          password: {
              required: validators_18,
              minLength: validators_13(6)
          },
          passwordConfirm: {
              required: validators_18,
              minLength: validators_13(6),
              sameAs: validators_21('password')
          }
      },
      methods: {
          onSubmitClick () {
      ...
      _c("table", { staticClass: "table table-striped table-responsive-lg" }, [
        _c("thead", [
          _c("tr", [
            ...
            _vm._v(" "),
            _c("th", [_vm._v(_vm._s(_vm.t("FREQUENCY")))]),
            _vm._v(" "),
            ...
            _vm._l(_vm.subscriptions, function(subscription) {
              return [
                _c(
                  "tr",
                  {
                    key: "info" + subscription.id,
                    on: {
                      click: function($event) {
                        return _vm.toggle(subscription)
                      }
                    }
                  },
                  [
                    ...
                    _c("td", [
                      _vm._v(
                        _vm._s(subscription.send_at) +
                          " " +
                          _vm._s(subscription.tz)
                      )
                    ]),
                    _vm._v(" "),
                    _c("td", [
                    ...
                    directives: [
                      {
                        name: "show",
                        rawName: "v-show",
                        value: _vm.openedSubscription === subscription.id,
                        expression: "openedSubscription === subscription.id"
                      }
                    ],
                    key: "filters" + subscription.id,
                    staticStyle: { display: "table-row" }
                  },
                  [
                    _c("td", { attrs: { colspan: "6" } }, [
                      _vm.isSubscriptionHasFilters(subscription)
                        ? _c(
                            "ul",
                            _vm._l(subscription.json_data, function(
                              value,
                              filter
                            ) {
                              return _c("li", { key: filter }, [
                                _vm._v(
                                  "\n                            " +
                                    _vm._s(filter) +
                                    ": " +
                      ...
                      _vm._v(" "),
                      !_vm.isSubscriptionHasFilters(subscription)
                        ? _c("span", [_vm._v("No filters founded")])
                        : _vm._e()
                    ])
                  ]
                )
  ...
  //
              ...
              fetchPermissions () {
                  return fetch(`${this.server}/auth/permissions`)
                      ...
                      .then(permissions => {
                          ...
                          this.permissions.push(...permissions);
                          this.permissions.sort(permissionSort$2);
                      })
                      .catch(e => {
                          console.error('Error fetching user to edit', e);
                      });
      ...
      function groupSort$1 (a, b) {
          return a.name.toLowerCase().localeCompare(b.name.toLowerCase());
      }
      function permissionSort$2 (a, b) {
          return a.alias.toLowerCase().localeCompare(b.alias.toLowerCase());
      }
  ...
  var __vue_render__$b = function() {
    ...
    return _c(
      ...
      [
        _c(
          "div",
          { ref: "modalWrapper", staticClass: "modal-window user-edit-modal" },
          [
            _c("div", { ref: "modal", staticClass: "modal fade" }, [
              _c(
                "div",
                ...
                [
                  _c("div", { staticClass: "modal-content" }, [
                    _c("header", { staticClass: "modal-header" }, [
                      !_vm.userId ? _c("h3", [_vm._v("Add User")]) : _vm._e(),
                      _vm._v(" "),
                      _vm.userId ? _c("h3", [_vm._v("Edit User")]) : _vm._e()
                    ]),
                    _vm._v(" "),
                    _c("main", { staticClass: "modal-body" }, [
                      _c("div", { staticClass: "container-fluid" }, [
                              ...
                              [
                                _c("div", { staticClass: "mb-3" }, [
                                  ...
                                  _c("input", {
                                    directives: [
                                      {
                                        name: "model",
                                        rawName: "v-model",
                                        value: _vm.userToEdit.fullname,
                                        expression: "userToEdit.fullname"
                                      }
                                    ],
                                    ref: "name",
                                    staticClass: "form-control",
                                    ...
                                    domProps: { value: _vm.userToEdit.fullname },
                                    on: {
                                      input: function($event) {
                                        if ($event.target.composing) {
                                          return
                                ...
                                _c("div", { staticClass: "mb-3" }, [
                                  ...
                                  _c("input", {
                                    directives: [
                                      {
                                        name: "model",
                                        rawName: "v-model",
                                        value: _vm.userToEdit.username,
                                        expression: "userToEdit.username"
                                      }
                                    ],
                                    ref: "username",
                                    staticClass: "form-control",
                                    ...
                                    domProps: { value: _vm.userToEdit.username },
                                    on: {
                                      input: function($event) {
                                        if ($event.target.composing) {
                                          return
                                  ...
                                  _vm._v(" "),
                                  _c("div", { staticClass: "invalid-feedback" }, [
                                    _vm._v("Please provide a username")
                                  ])
                                ]),
                                _vm._v(" "),
                                _c("div", { staticClass: "mb-3" }, [
                                ...
                                _c("div", { staticClass: "mb-3" }, [
                                  ...
                                  _c("input", {
                                    ...
                                    domProps: { value: _vm.userToEdit.email },
                                    on: {
                                      input: function($event) {
                                        if ($event.target.composing) {
                                          return
                                            ...
                                            directives: [
                                              {
                                                name: "model",
                                                rawName: "v-model",
                                                value: _vm.userToEdit.admin,
                                                expression: "userToEdit.admin"
                                              }
                                            ],
                                  ...
                                  ? _c(
                                      ...
                                      [
                                        _c(
                                          ...
                                          [_vm._v(_vm._s(_vm.error.status))]
                                        ),
                                        _vm._v(
                                          "\n                                                " +
                                        ...
                                        _vm.error && _vm.error.detail
                                          ? _c("hr")
                                          : _vm._e(),
                                        _vm._v(" "),
                                        _c("p", { staticClass: "mb-0" }, [
                                          _vm._v(_vm._s(_vm.error.detail))
                                        ])
                                      ]
                                    )
                                  : _vm._e()
  ...
  var script$c = {
      ...
      components: {UserEditModal: __vue_component__$b}
  };
  ...
  __vue_render__$c._withStripped = true;
    ...
    const __vue_inject_styles__$c = function (inject) {
      if (!inject) return
      inject("data-v-16eae1fa_0", { source: ".user-add-button__wrapper[data-v-16eae1fa] {\n  font-family: -apple-system, BlinkMacSystemFont, \"Segoe UI\", Roboto, \"Helvetica Neue\", Arial, sans-serif, \"Apple Color Emoji\", \"Segoe UI Emoji\", \"Segoe UI Symbol\";\n  -webkit-font-smoothing: antialiased;\n  -moz-osx-font-smoothing: grayscale;\n  text-align: center;\n  color: #212529;\n}\n.user-add-button__wrapper *[data-v-16eae1fa], .user-add-button__wrapper[data-v-16eae1fa] ::after, .user-add-button__wrapper[data-v-16eae1fa] ::before {\n  box-sizing: border-box;\n}\n.user-add-button__wrapper .btn[data-v-16eae1fa] {\n  border-radius: 2px;\n  padding: 0.5rem 1rem;\n  line-height: 1.5rem;\n  font-size: 1rem;\n  font-weight: bold;\n  border: none;\n  margin-bottom: 20px;\n  color: #fff;\n}\n.user-add-button__wrapper .btn-primary[data-v-16eae1fa] {\n  background: #fa225b;\n}\n.user-add-button__wrapper .btn-link[data-v-16eae1fa] {\n  color: #fa225b;\n}\n.user-add-button__wrapper .btn-block[data-v-16eae1fa] {\n  display: block;\n  width: 100%;\n}\n.user-add-button__wrapper .btn[data-v-16eae1fa]:hover {\n  cursor: pointer;\n  box-shadow: 0 0 10px 4px rgba(250, 34, 91, 0.1);\n}\n.user-add-button__wrapper .btn[data-v-16eae1fa]:focus {\n  outline: 0;\n}\n\n/*# sourceMappingURL=UserAddButton.vue.map */", map: {"version":3,"sources":["/Users/dylanspurgin/dev/apitoolbox-ui/src/elements/UserAddButton/UserAddButton.vue","UserAddButton.vue"],"names":[],"mappings":"AA0CA;EACA,iKAAA;EACA,mCAAA;EACA,kCAAA;EACA,kBAAA;EACA,cAAA;ACzCA;AD2CA;EACA,sBAAA;ACzCA;AD4CA;EACA,kBAAA;EACA,oBAAA;EACA,mBAAA;EACA,eAAA;EACA,iBAAA;EACA,YAAA;EACA,mBAAA;EACA,WAAA;AC1CA;AD4CA;EACA,mBAAA;AC1CA;AD4CA;EACA,cAAA;AC1CA;AD4CA;EACA,cAAA;EACA,WAAA;AC1CA;AD4CA;EACA,eAAA;EACA,+CAAA;AC1CA;AD4CA;EACA,UAAA;AC1CA;;AAEA,4CAA4C","file":"UserAddButton.vue","sourcesContent":["<template>\n    <div class=\"user-add-button__wrapper\">\n        <button class=\"btn btn-block btn-primary\" v-on:click=\"onAddUserClick\">{{buttonText || 'Add User'}}</button>\n        <user-edit-modal :user-to-edit=\"user\" :open-modal=\"openModal\" :on-close=\"onModalClose\"></user-edit-modal>\n    </div>\n</template>\n\n<script>\n    import UserEditModal from '../UserEditModal/UserEditModal.vue'\n    export default {\n        name: 'UserAddButton',\n        props: {\n            server: String,\n            buttonText: String\n        },\n        data: () => {\n            return {\n                user: {\n                    groups: [],\n                    permissions: []\n                },\n                openModal: false\n            }\n        },\n        methods: {\n            onAddUserClick () {\n                this.openModal = false;\n                window.setTimeout(() => {\n                    this.openModal = true;\n                });\n            },\n            onModalClose () {\n                console.debug('modal close callback')\n                this.openModal = false\n            }\n        },\n        components: {UserEditModal}\n    }\n</script>\n\n<style scoped lang=\"scss\">\n    \n    .user-add-button__wrapper {\n        font-family: -apple-system,BlinkMacSystemFont,\"Segoe UI\",Roboto,\"Helvetica Neue\",Arial,sans-serif,\"Apple Color Emoji\",\"Segoe UI Emoji\",\"Segoe UI Symbol\";\n        -webkit-font-smoothing: antialiased;\n        -moz-osx-font-smoothing: grayscale;\n        text-align: center;\n        color: #212529;\n\n        *, ::after, ::before {\n            box-sizing: border-box;\n        }\n\n        .btn {\n            border-radius: 2px;\n            padding: .5rem 1rem;\n            line-height: 1.5rem;\n            font-size: 1rem;\n            font-weight: bold;\n            border: none;\n            margin-bottom: 20px;\n            color: #fff;\n        }\n        .btn-primary {\n            background: #fa225b;\n        }\n        .btn-link {\n            color: #fa225b;\n        }\n        .btn-block {\n            display: block;\n            width: 100%;\n        }\n        .btn:hover {\n            cursor: pointer;\n            box-shadow: 0 0 10px 4px rgba(250, 34, 91, 0.1);\n        }\n        .btn:focus {\n            outline: 0;\n        }\n    }\n</style>\n",".user-add-button__wrapper {\n  font-family: -apple-system, BlinkMacSystemFont, \"Segoe UI\", Roboto, \"Helvetica Neue\", Arial, sans-serif, \"Apple Color Emoji\", \"Segoe UI Emoji\", \"Segoe UI Symbol\";\n  -webkit-font-smoothing: antialiased;\n  -moz-osx-font-smoothing: grayscale;\n  text-align: center;\n  color: #212529;\n}\n.user-add-button__wrapper *, .user-add-button__wrapper ::after, .user-add-button__wrapper ::before {\n  box-sizing: border-box;\n}\n.user-add-button__wrapper .btn {\n  border-radius: 2px;\n  padding: 0.5rem 1rem;\n  line-height: 1.5rem;\n  font-size: 1rem;\n  font-weight: bold;\n  border: none;\n  margin-bottom: 20px;\n  color: #fff;\n}\n.user-add-button__wrapper .btn-primary {\n  background: #fa225b;\n}\n.user-add-button__wrapper .btn-link {\n  color: #fa225b;\n}\n.user-add-button__wrapper .btn-block {\n  display: block;\n  width: 100%;\n}\n.user-add-button__wrapper .btn:hover {\n  cursor: pointer;\n  box-shadow: 0 0 10px 4px rgba(250, 34, 91, 0.1);\n}\n.user-add-button__wrapper .btn:focus {\n  outline: 0;\n}\n\n/*# sourceMappingURL=UserAddButton.vue.map */"]}, media: undefined });

    };
    /* scoped */
    const __vue_scope_id__$c = "data-v-16eae1fa";
    /* module identifier */
  ...
  var script$d = {
      ...
      components: {
          UserEditModal: __vue_component__$b,
          ConfirmationModal: __vue_component__$1
      }
  };
      ...
      [
        _c("div", { staticClass: "row justify-content-sm-end" }, [
          ...
          _c("div", { staticClass: "col col-sm-6 d-flex justify-content-end" }, [
            _c(
              "button",
              { staticClass: "btn btn-primary", on: { click: _vm.onAddClick } },
              [_vm._v("Add User")]
            )
          ])
        ]),
                      ...
                      _c("td", [
                        _c(
                          "button",
                          {
                            ...
                            on: {
                              click: function($event) {
                                return _vm.onViewClick(user.id)
                              }
                            }
                          },
                          [_vm._v("View")]
        ...
        _c("user-edit-modal", {
          attrs: {
            "user-id": _vm.userToEdit.id,
            "open-modal": _vm.openModal,
            "on-close": _vm.onModalClose
          }
        }),
        _vm._v(" "),
        _c("confirmation-modal", { ref: "confirmationModal" })
      ],
      1
    )
  };
      ...
      methods: {
          ...
          fetchUserPermissions () {
              return fetch(`${this.server}/auth/users/${this.userId}/permissions`)
                  ...
                  .then(permissions => {
                      this.permissions = permissions;
                      this.permissions.sort(permissionSort$3);
                  })
                  .catch(e => {
                      console.error('Error fetching user to edit', e);
                  });
          ...
          fetchGroupPermission (group) {
              return fetch(`${this.server}/auth/groups/${group.id}/permissions`)
                  ...
                  .then(permissions => {
                      ...
                      group.permissions.sort(permissionSort$3);
                      return group;
                  })
                  .catch(e => {
  ...
  function groupSort$2 (a, b) {
      return a.name.toLowerCase().localeCompare(b.name.toLowerCase());
  }
  function permissionSort$3 (a, b) {
      return a.alias.toLowerCase().localeCompare(b.alias.toLowerCase());
  }
  ...
  var __vue_render__$e = function() {
    ...
    return _c(
      "div",
      { staticClass: "user-view__wrapper container" },
      [
        _c("div", { staticClass: "row" }, [
          _c("div", { staticClass: "col-4 d-flex justify-content-end" }, [
        ...
        _c("div", { staticClass: "row py-2" }, [
          ...
          _c(
            "div",
            { staticClass: "col-8 d-flex flex-wrap justify-content-start" },
            _vm._l(_vm.groups, function(group) {
              return _c(
                "ul",
                { staticClass: "list-group mr-2 mb-2" },
                [
                  ...
                  _vm._l(group.permissions, function(permission) {
                    return _c(
                      "li",
                      { staticClass: "list-group-item text-nowrap" },
                      [_vm._v(_vm._s(permission.alias))]
                    )
                  })
                ],
        ...
        _c("div", { staticClass: "row py-2" }, [
          ...
          _c("div", { staticClass: "col-8 d-flex justify-content-start" }, [
            _vm._v(
              "\n            " +
                _vm._s(_vm.user.admin ? "TRUE" : "FALSE") +
                "\n        "
            )
          ])
        ]),
        ...
        _c("div", { staticClass: "row py-2" }, [
          ...
          _c("div", { staticClass: "col-8 d-flex justify-content-start" }, [
            _vm._v(
              "\n            " +
                _vm._s(_vm._f("dateTimeFormat")(_vm.user.created_at)) +
                "\n        "
            )
          ])
        ]),
        ...
        _c("div", { staticClass: "row py-2" }, [
          ...
          _c("div", { staticClass: "col-8 d-flex justify-content-start" }, [
            _vm._v(
              "\n            " +
                _vm._s(_vm._f("dateTimeFormat")(_vm.user.updated_at)) +
                "\n        "
            )
          ])
        ]),
  ...
  Vue.customElement('background-visual', __vue_component__);
  Vue.customElement('confirmation-modal', __vue_component__$1);
  Vue.customElement('group-edit-modal', __vue_component__$2);
  Vue.customElement('group-list', __vue_component__$3);
  Vue.customElement('group-view', __vue_component__$4);
  Vue.customElement('login-form', __vue_component__$5);
  Vue.customElement('permission-edit-modal', __vue_component__$6);
  Vue.customElement('permission-list', __vue_component__$7);
  Vue.customElement('sign-up-form', __vue_component__$8);
  Vue.customElement('subscribe-modal', __vue_component__$9);
  Vue.customElement('subscription-list', __vue_component__$a);
  Vue.customElement('user-add-button', __vue_component__$c);
  Vue.customElement('user-edit-modal', __vue_component__$b);
  Vue.customElement('user-list', __vue_component__$d);
  Vue.customElement('user-view', __vue_component__$e);

  exports.BackgroundVisual = __vue_component__;
  exports.ConfirmationModal = __vue_component__$1;
  exports.GroupEditModal = __vue_component__$2;
  exports.GroupList = __vue_component__$3;
  exports.GroupView = __vue_component__$4;
  exports.LoginForm = __vue_component__$5;
  exports.PermissionEditModal = __vue_component__$6;
  exports.PermissionList = __vue_component__$7;
  exports.SignUpForm = __vue_component__$8;
  exports.SubscribeModal = __vue_component__$9;
  exports.SubscriptionList = __vue_component__$a;
  exports.UserAddButton = __vue_component__$c;
  exports.UserEditModal = __vue_component__$b;
  exports.UserList = __vue_component__$d;
  exports.UserView = __vue_component__$e;
